...
{
  public iFileUpLoad2000(HttpServletRequest request) throws GlobalException
  {
      int totalRead = 0;
      int readBytes = 0;
      int mSingCur = 0;
  ...
  public boolean SaveAll(String FileName) throws GlobalException
  {
  ...
  public boolean SaveFile(String TagName, String FileName) throws GlobalException
  {
      String mFileName = "";
      boolean result = false;
      mFileName = FileName;
