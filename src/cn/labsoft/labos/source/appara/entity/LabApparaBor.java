...
@Entity
@Table(name="lab_appara_bor")
public class LabApparaBor extends AbstractBasePo{
	
	private String appId;
	private String appName;
	private String appNo;
	private String appKeeper;
	...
	public String getAppKeeper() {
		return appKeeper;
	}
	public void setAppKeeper(String appKeeper) {
