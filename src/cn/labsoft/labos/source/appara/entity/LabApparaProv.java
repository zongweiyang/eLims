...
/**
 * LabApparaProv entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="lab_appara_prov")
public class LabApparaProv extends AbstractBasePo {

	private LabAppara labAppara;

	private String labAppName;
	private String labAppNo;
	private String spec;
	...
	public String getLabAppName() {
		return labAppName;
	}
	public void setLabAppName(String labAppName) {
		this.labAppName = labAppName;
	}
	public String getLabAppNo() {
		return labAppNo;
	}
	public void setLabAppNo(String labAppNo) {
		this.labAppNo = labAppNo;
	}
