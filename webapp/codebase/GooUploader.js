...
function GooUploader(Div,property){
	...
	this.$swfUpload=new SWFUpload({
		...
		flash_url : property.flash_url||basePath+"codebase/swfupload/swfupload.swf",//SWF插件所在路径
    ...
    this.$swfUpload.uploadSuccess=function(file,msg){
        ...
        var t = li.parent().scrollTop();
        li.parent().scrollTop(t+20);
    };
