...
Ext.define('Ext.ux.desktop.TaskBar', {
    ...
    getTrayConfig: function () {
        var ret = {
            width: 80,
            items: '<div id="footerItem"><span class="tongzhi"></span><span class="email"></span></div>'//this.trayItems
        };
    ...
    onButtonContextMenu: function (e) {
        ...
        if (btn) {
            e.stopEvent();
            var id = btn.win.id.replace('-win','');
            if ( Ext.get(id+'add-win') || Ext.get(id+'update-win') || Ext.get(id+'cog-win') ) {
            	me.windowMenu.items.items[4].setDisabled(true);
            }
            else{
            	me.windowMenu.items.items[4].setDisabled(false);
            }
