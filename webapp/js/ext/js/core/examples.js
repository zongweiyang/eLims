Ext.example = function(){
    ...
    function createBox(t, s, c){
    	if(Ext.query(".msg").length>0){
    		Ext.get("msg-div").first().remove(); 
        }
        if(c == undefined){
        	c = '';
        }
    ...
    return {
        msg : function(title, format, styleName){
            if(!msgCt){
                msgCt = Ext.DomHelper.insertFirst(document.body, {id:'msg-div'}, true);
            }
            var s = Ext.String.format.apply(String, Array.prototype.slice.call(arguments, 1));
            var m = Ext.DomHelper.append(msgCt, createBox(title, s, styleName), true);
            var delay = 2500;
...
Ext.example1 = function(){
    var msgCt;

    function createBox(t, s, c){
    	if(Ext.query(".msg").length>0){
    		Ext.get("msg1-div").first().remove(); 
        }
        if(c == undefined){
        	c = '';
        }
    ...
    return {
        msg : function(title, format, styleName){
            if(!msgCt){
                msgCt = Ext.DomHelper.insertFirst(document.body, {id:'msg1-div'}, true);
            }
            var s = Ext.String.format.apply(String, Array.prototype.slice.call(arguments, 1));
            var m = Ext.DomHelper.append(msgCt, createBox(title, s, styleName), true);
            var delay = 2500;
...
Ext.onReady(Ext.example1.init, Ext.example1);
