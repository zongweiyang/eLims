						...
						<form action="" method="post" name="commcodeform">
											...
											<table cellspacing="0" cellpadding="0" border="0">
												<tr>
													...
													<td>
														<a id="BtnPreview" class="zPushBtn"
															href="javascript:void();"
															onclick="save('updateLabCode.action');return false;"><img
																height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="lab.code.save"/></b>
														</a>
													</td>
												</tr>
											</table>
							...
							<div class="Formtable">
								<div class="Formtabletitle" onclick="$(this).next().toggle()"
									...
									<span><s:text name="lab.code.info"></s:text></span>
								</div>
								<div class="TabTable"
