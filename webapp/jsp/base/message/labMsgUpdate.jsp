...
html {
	...
	<body>
		<form action="" method="post" name="sysMessageForm" id="form">
			<input type="hidden" value="${labMsgMainVo.id}" name="labMsgMainVo.id" />
											...
											<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														...
														<td>
															<l:a uri="/message/messageMain/updateLabMsg.action" onclick="submitvalue('updateLabMsg.action?labMsgMainVo.position=0');return false;" value="msg.send.msg" />
														</td>
														<td>
															<l:a uri="/message/messageMain/updateLabMsg.action" onclick="submitvalue('updateLabMsg.action?labMsgMainVo.position=2');return false;" img="/img/add.gif" value="msg.save.drfat" />
														</td>
													</tr>
												</table>
											</td>
								...
								<div class="Formtable">
									...
									<table class="FormtableCon">
										...
										<tr>
											...
											<td>
												<a id="BtnPreview" class="zPushBtn" href="javascript:;" onclick="uploadFile('${labMsgMainVo.id}','msg');" height="20" width="20"><img height="20" width="20" src="<%=basePath%>img/filesave.gif" /> <b><s:text name="msg.add.attach"></s:text></b> </a>
												<div id="upfiles">
													<s:iterator value="#request.uploadList" status="st">
