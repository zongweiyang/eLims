								...
								<div class="Formtable">
									...
									<table class="FormtableCon">
										<tr>
											...
											<td>
												<input name="labOrgVo.linkMan" valType="strLength"  max="10" msg="最多输入10个汉字"  id="linkMan" type="text" size="20" />
											</td>
										</tr>
										<tr>
											<td>
											...
											<td>
												...
												<input type="hidden"  id="typeId" valType="required" msg="请选择组织类型" name="labOrgVo.typeId"  />
