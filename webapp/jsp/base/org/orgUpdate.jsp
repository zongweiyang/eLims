								...
								<div class="Formtable">
									...
									<table class="FormtableCon">
										...
										<tr>
											...
											<td>
												<s:select list="#request.listLabCode" cssStyle="width:153px" headerKey="0" headerValue="" onchange="checkLab(this)"  value="'${labOrgVo.typeId}|${labOrgVo.type}'"   theme="simple" listValue="name" listKey="id+'|'+name" ></s:select>
