...
html {
	...
	var api = frameElement.api, W = api.opener, D = W.document; // api.opener 为载加lhgdialog.min.js文件的页面的window对象
		...
		function submitvalueforlist(){
			...
			df.action=basePath+"role/labRole/updateLabRoleTree.action?labRoleVo.isSynchro="+type+"&labRoleVo.funIds = " + funIds;
		    df.submit();
		}
								...
								<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
									<table cellspacing="0" cellpadding="0" border="0">
										<tr>
											...
											<td>
												<a id="BtnPreview" class="zPushBtn" href="javascript:;" onclick="submitvalueforlist();return false;"><img height="20" width="20" src="<%=basePath%>img/accept.gif" /><b><s:text name="page.confirm"></s:text></b> </a>
											</td>
										</tr>
									</table>
								</td>
					...
					<table class="FormtableCon">
						<tr>
							<td>
								...
								<s:text name="samepace.show"></s:text>
							</td>
						</tr>
						<tr>
							<td>
