									...
									<div class="myworkingbox">
										<div class="myworkingboxttitle">
											<h2>
												...
												<span><s:text name="page.first"/></span>
											</h2>
										</div>
													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															...
															<s:if test="${isVague}==1">
																...
																<s:if test="${isSort}==1">
																	<td>
																		<s:select list="#{'1':getText('selected.pls'),'ASC':getText('up.order'),'DESC':getText('down.order')}" theme="simple" value="'${isSortValue}'" name="labQueryVo.listQuery[${st.index}].isSortValue"></s:select>
													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="javascript:void(0);" onclick="submitvalue('/user/labUser/listUserQuery.action'); return false;"><img height="20" width="20" src="${basePath}img/chakan.gif" /><b><s:text name="fun.query"></s:text></b> </a>
																</td>
																</td>
															</tr>
														</table>
