				...
				<td id="bodyCell" class="oRight">
					<div class="myworkingbox">
						<div class="myworkingboxttitle">
							<h2>
								${funName}：
								<span><s:text name="admin.add"></s:text></span>
							</h2>
						</div>
											...
											<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														...
														<td>
															<l:a uri="user/labUserTrain/addLabUserTrain.action" value="lab.code.save" />
														</td>
													</tr>
												</table>
											</td>
									...
									<table class="FormtableCon">
										...
										<tr>
											...
											<td colspan="3">
												...
												&nbsp;&nbsp;<input type="checkbox" name="labUserTrainVo.isMsg" value="Y"/>&nbsp;<s:text name="msg.notify"></s:text>
												&nbsp;&nbsp;<input type="checkbox" name="labUserTrainVo.isSms" value="Y"/>&nbsp;<s:text name="sms.notify"></s:text>
											</td>
										</tr>
										<tr>
											<td>
