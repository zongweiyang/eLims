				...
				<td id="bodyCell" class="oRight">
					<div class="myworkingbox">
						<div class="myworkingboxttitle">
							<h2>
								${funName}：
								<span><s:text name="record.modify"/></span>
							</h2>
						</div>
											...
											<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														...
														<td>
															<l:a uri="user/labUserTrain/updateLabUserTrain4Record.action" img="/img/add.gif" value="lab.code.save" />
														</td>
													</tr>
												</table>
											</td>
									...
									<table class="FormtableCon">
										...
										<s:iterator value="labUserTrainVo.recordList" status="st">
											<tr>
												...
												<td class="w100 c">
													${labUserName}
													<input type="hidden" name="labUserTrainVo.recordList[${st.index}].labUserId" value="${labUserId}" id="labUserId${st.index+1}" />
												</td>
												<td class="c">
													<input size="20" type="text" name="labUserTrainVo.recordList[${st.index}].result" value="${result}" id="result${st.index+1}" />
												</td>
												<td class="c">
													<input size="15" type="text" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" name="labUserTrainVo.recordList[${st.index}].tdate" value="${tdate}" id="tdate${st.index+1}" />
												</td>
												<td class="c">
													<input size="40" type="text" name="labUserTrainVo.recordList[${st.index}].remark" value="${remark}" id="remark${st.index+1}" />
												</td>
											</tr>
										</s:iterator>
									</table>
