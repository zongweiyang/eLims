												...
												<s:if test="pageResult.resultList!=null">
													...
													<s:iterator value="#alllist" status="st">
														<tr>
															...
															<td class="c">
																<s:if test="${isHandle=='Y'}">
																	<s:text name="sam.dealed"/>
																</s:if>
																<s:else>
																	<s:text name="sam.undealed"/>
																</s:else>
															</td>
															<td class="c">
																<s:if test="${isHandle=='Y'}">
																	<l:a href="javascript:;" uri="sam/labSam/showLabSam4Destory.action?labSamMainVo.id=${id}" value="look.check"/>
																</s:if>
																<s:else>
																	<l:a href="javascript:;" uri="sam/labSam/preUpdateLabSam4Destory.action?labSamMainVo.id=${id}" value="deal.with" />
																</s:else>	
															</td>
														</tr>
													</s:iterator>
