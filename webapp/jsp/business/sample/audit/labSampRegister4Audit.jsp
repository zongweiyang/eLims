					...
					<div class="myworkingbox">
						...
						<form action="" method="post" name="mouldForm">
							...
							<div class="TabTable">
											...
											<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														...
														<td>
															<l:a uri="sample/labSampRegister/updateLabSampRegister4Audit.action" onclick="submitvalue('sample/labSampRegister/updateLabSampRegister4Audit.action?labSampRegisterVo.auditResult=1');return false;"  value="flow.pass" img="/img/icon/filesave.gif"/>
														</td>
														<td>
															<l:a uri="sample/labSampRegister/updateLabSampRegister4Audit.action" onclick="submit2Back('sample/labSampRegister/updateLabSampRegister4Audit.action?labSampRegisterVo.auditResult=-1');return false;"  value="flow.return" img="/img/icon/filesave.gif"/>
														</td>
													</tr>
												</table>
											</td>
												...
												<td colspan="4">
													<table class="FormtableCon_sform">
														<tr>
															...
															<td class="r">
																${labChargeVo.preferential}(<s:text name="theme.yuan"></s:text>)
															</td>
															<td>
																<label><s:text name="total.payed"/>：</label>
															</td>
															<td class="r">
																${labChargeVo.payMoney}(<s:text name="theme.yuan"></s:text>)
															</td>
														</tr>
													</table>
												</td>
								...
								<div class="Formtable">
									<div class="Formtabletitle">
										<span><s:text name="lookinfo"/></span>
									</div>
									<div>
										<table class="FormtableCon_sform">
											<tr>
												<td>
													<label><s:text name="audit.opn"/>：</label>
												</td>
												<td>
