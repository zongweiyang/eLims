											...
											<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														...
														<td>
															<l:a uri="sample/labSampRegister/updateLabSampRegister4Check.action" onclick="submitvalue('sample/labSampRegister/updateLabSampRegister4Check.action?labSampRegisterVo.auditResult=1');return false;" value="flow.pass" img="/img/icon/filesave.gif"/>
														</td>
														<td>
															<l:a uri="sample/labSampRegister/updateLabSampRegister4Check.action" onclick="submit2Back('sample/labSampRegister/updateLabSampRegister4Check.action?labSampRegisterVo.auditResult=-1');return false;" value="flow.return" img="/img/icon/filesave.gif"/>
														</td>
													</tr>
												</table>
											</td>
