													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															...
															<tr>
																...
																<td>
																	<s:select theme="simple" list="#request.funStepList" listKey="stepId" listValue="stepName" headerKey="" headerValue="-全部-" name="labSampRegisterVo.status" id="status" onchange="submitvalue('sample/labSampRegister/listLabSampRegister4Audit.action');">
																	</s:select>
																</td>
																<td>
													...
													<s:if test="pageResult.resultList!=null">
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="c">
																	<s:if test="${isOper=='Y'}">
																		<l:a href="#" uri="sample/labSampRegister/showLabSampRegister4Audit.action?labSampRegisterVo.id=${id}" value="flow.check" />
																	</s:if>
																	<s:else>
																		<font><s:text name="flow.check"/></font>
																	</s:else>
																</td>
															</tr>
														</s:iterator>
