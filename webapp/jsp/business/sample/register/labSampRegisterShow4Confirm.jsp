										...
										<tr>
											<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														<td>
															<l:a uri="sample/labSampRegister/addLabSampRegister4Tab2.action" onclick="ok('/sample/labSampRegister/addLabSampRegister4Tab2.action?labSampRegisterVo.auditResult=1');" value="page.confirm"  img="/img/icon/filesave.gif"/>
														</td>
													</tr>
												</table>
											</td>
