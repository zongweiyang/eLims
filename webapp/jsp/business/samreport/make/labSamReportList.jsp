															...
															<tr>
																...
																<td>
																	<s:select theme="simple" list="#request.funStepList"
																		...
																		headerValue='' name="labSamReportVo.status"
																		id="status"
																		onchange="submitvalue('samreport/labSamReport/listLabSamReport.action');">
																	</s:select>
																</td>
																<td>
																	<l:a uri="${SessionContainer.lastUrl}"
																		onclick="submitAction();" value="fun.back" />
																</td>
															</tr>
														</table>
													</td>
										...
										<table class="myworkingboxttable" cellspacing="1"
											...
											<thead>
												<tr>
													...
													<th property="labCustomerName"><s:text name="lec.cust.no"/></th>
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="c">
																	<s:if test="${isOper=='Y'}">
																		<l:a href="#"
																		uri="samreport/labSamReport/preUpdateLabSamReport.action?labSamReportVo.id=${id}"
																		value="sam.code" />
																	</s:if>
																	<s:else>
