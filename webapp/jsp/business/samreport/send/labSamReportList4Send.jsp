															...
															<tr>
																...
																<td>
																	<s:select theme="simple" list="#request.funStepList"
																		...
																		id="status"
																		onchange="submitvalue('samreport/labSamReport/listLabSamReport4Send.action');">
																	</s:select>
																</td>
																<td>
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="c">
																	<s:if test="${isOper=='Y'}">
																		<l:a href="#"
																		uri="samreport/labSamReport/preUpdateLabSamReport4Send.action?labSamReportVo.id=${id}"
																		value="sam.send" />
																	</s:if>
																	<s:else>
