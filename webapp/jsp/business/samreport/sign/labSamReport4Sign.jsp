				...
				<td id="bodyCell" class="oRight">
					<div class="myworkingbox">
						...
						<form theme="simple" action="" method="post"
							...
							<s:token></s:token>
							<input type="hidden" name="labSamReportVo.id"
								value="${labSamReportVo.id}" />
											...
											<td class="blockTd"
												...
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														...
														<td>
															<l:a uri="samreport/labSamReport/updateLabSamReport4Audit.action"
																onclick="submitvalue('samreport/labSamReport/updateLabSamReport4Audit.action?labSamReportVo.auditResult=1');return false;"
																value="flow.pass" img="/img/icon/filesave.gif"/>
														</td>
														<td>
															<l:a uri="samreport/labSamReport/updateLabSamReport4Audit.action"
																onclick="submit2Back('samreport/labSamReport/updateLabSamReport4Audit.action?labSamReportVo.auditResult=-1');return false;"
																value="flow.return" img="/img/icon/filesave.gif"/>
														</td>
													</tr>
												</table>
											</td>
									...
									<div>
										<table class="FormtableCon_sform">
											<tr>
												...
												<td>
													<textarea rows="4" cols="60" name="labSamReportVo.auditMessage" id="auditMessage">${labSamReportVo.auditMessage}</textarea>
												</td>
											</tr>
										</table>
									</div>
