...
html {
	...
	<body class="" id="mainid" style="overflow-y: auto; height: 100%">
		<form action="" method="post" name="sampTestIssuedFrom" id="sampRegisterFrom">
				...
				<tr>
					...
					<td id="bodyCell" class="oRight">
						<table class="workingBody" cellspacing="0" cellpadding="0" border="0">
												...
												<tr>
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																<td>
																	<l:a uri="samtest/labSamTask/preUpdateSamTask4IssuedBeach.action" onclick="submitvalue('samtest/labSamTask/preUpdateSamTask4IssuedBeach.action');" img="img/add.gif" value="batch.send" />
																</td>
															</tr>
														</table>
													</td>
										...
										<table class="myworkingboxttable" cellspacing="1" cellpadding="0">
											<thead>
												<tr>
													...
													<th property="taskType">
														<s:text name="checking.type"/>
													</th>
													<th property="reportType">
														<s:text name="report.type"/>
													</th>
													<th property="finishDate">
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="l" style="padding-left: 20px;">
																	<a href="javascript:;" onclick="showProcess('${id}');return false">${status} <s:if test="${isBack=='Y'}">
																			<img src="${basePath}/img/tishi_icon.gif" width="12" height="12" />
																		</s:if> </a>
																</td>
																<td class="c">
																	<s:if test="${isOper=='Y'}">
																		<l:a href="#" uri="samtest/labSamTask/preUpdateLabSamTask4Issued.action?labSamTestVo.taskId=${id}" value="send.to" />
																	</s:if>
																	<s:else>
																		<font><s:text name="send.to"></s:text></font>
																	</s:else>
																</td>
															</tr>
														</s:iterator>
							...
							<tr>
								<td align="center"><jsp:include page="/jsp/include/page.jsp?formName=sampTestIssuedFrom" flush="true" /></td>
							</tr>
						</table>
					</td>
					<td class="MRimg"></td>
