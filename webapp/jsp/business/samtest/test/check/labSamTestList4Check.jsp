													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<input  name="labSamTestBeatchVo.name" value="${labSamTestBeatchVo.name}" />
																</td>
																<td>
																	<label>
																...
																<td>
																	<s:select theme="simple" list="#request.funStepList"
																		...
																		headerValue="-全部-" name="labSamTestBeatchVo.status"
																		id="status"
													...
													<s:if test="pageResult.resultList!=null">
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="c">
																	<l:a href="#" uri="samtest/labSamTest/preUpdateLabSamTest4Check.action?labSamTestBeatchVo.id=${id}&&labSamTestBeatchVo.itemIds=${itemIds}" value="test" />
																</td>
															</tr>
														</s:iterator>
													</s:if>
