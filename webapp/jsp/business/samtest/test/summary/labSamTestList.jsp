													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<input  name="labSamTestVo.taskNo" value="${labSamTestVo.taskNo}" />
																</td>
																<td>
																	<label>
																...
																<td>
																	<s:select theme="simple" list="#request.funStepList"
																		...
																		headerValue="-全部-" name="labSamTestVo.status"
																		id="status"
																		onchange="submitvalue('samtest/labSamTest/listLabSamTest4Summary.action');">
																	</s:select>
																</td>
																<td>
										...
										<table class="myworkingboxttable" cellspacing="1"
											...
											<thead>
												<tr>
													...
													<th class="c"><s:text name="progressing"/></th>
													<th width="100">
													...
													<s:if test="pageResult.resultList!=null">
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="c">
																	<l:a href="#" uri="samtest/labSamTest/preLabSamTest4Summary.action?labSamTestVo.taskId=${id}" value="total.all" />
																</td>
															</tr>
														</s:iterator>
													</s:if>
