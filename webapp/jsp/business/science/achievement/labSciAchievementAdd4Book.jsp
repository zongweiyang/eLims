...
html {
	...
	<body class="" id="mainid">
		<form action="" method="post" name="studentForm">
			<input type="hidden" name="labSciAchievementVo.type" value="BOOK"
				id="type" />
																...
																<tr>
																	<td>
																		<l:a
																			...
																			onclick="nextUri('science/labSciAchievement/listLabSciAchievement.action?labSciAchievementVo.type=BOOK');"
																			value="msg.back" />
																	</td>
																	<td>
																		<l:a
																			uri="science/labSciAchievement/addLabSciAchievement.action"
																			value="lab.code.save" />
																	</td>
																</tr>
															</table>
													...
													<tr>
														...
														<td>
															<input type="text" name="labSciAchievementVo.name"
																...
																strLength-msg="论著名称长度不能超过64位" msg="论著名称不能为空" />
														</td>
													...
													<tr>
														...
														<td>
															<input type="text" name="labSciAchievementVo.wordNumber"
																...
																max="11" strLength-msg="论著字数的长度不能超过11位"
																number-msg="论著字数必须为数字" />
														</td>
													...
													<tr>
														...
														<td>
															<a id="BtnEdit" class="zPushBtn"
																...
																onclick="uploadFile('${labSciAchievementVo.uuid}','lab-sciAchievement');">
