											...
											<div class="Formtable">
												...
												<table class="FormtableCon">
													<tr>
														...
														<td>
															<input type="text" name="labSciAchievementVo.name"
																...
																strLength-msg="专利名称长度不能超过64位" msg="专利名称不能为空" />
														</td>
													...
													<tr>
														...
														<td>
															<input type="text" name="labSciAchievementVo.achievementNum"
																value="${labSciAchievementVo.achievementNum}"
																id="achievementNum" size="40" valType="required,strLength"
																max="64" strLength-msg="专利号的长度不能超过64位"
																msg="专利号不能为空" />
														</td>
