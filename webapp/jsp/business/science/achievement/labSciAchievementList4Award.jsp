	...
	<head>
		...
		function deleteOne(id){
			if(confirm('<s:property value="getText('lab.confirm.delete')"/>')){
				window.location.href='${basePath}science/labSciAchievement/deleteLabSciAchievement.action?labSciAchievementVo.type=AWARD&labSciAchievementVo.ids='+id;
			}	
		}
		function deleteBath(){
...
html {
	...
	<body class="" id="mainid" style="overflow-y: auto; height: 100%">
		<form action="" method="post" name="labSciAchievementFrom"
			...
			<input type="hidden" name="labSciAchievementVo.type" value="AWARD" id="type" />
												...
												<tr>
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
															    <td>
																	<l:a uri="science/labSciAchievement/preAddLabSciAchievement.action?labSciAchievementVo.type=AWARD"
																		value="admin.add" />
																</td>
																<td>
													...
													<s:if test="pageResult.resultList!=null">
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="l">
																	<a href="<%=basePath%>science/labSciAchievement/showLabSciAchievement.action?labSciAchievementVo.type=AWARD&labSciAchievementVo.id=${id}">${name}</a>
																</td>
																<td class="l">
																	${otherAuthorName}
																</td>
																...
																<td class="c">
																    <l:a href="#"
																		uri="science/labSciAchievement/preUpdateLabSciAchievement.action?labSciAchievementVo.type=AWARD&labSciAchievementVo.id=${id}"
																		value="lab.code.modify" />
																	<l:a href="#"
																		uri="science/labSciAchievement/deleteLabSciAchievement.action?labSciAchievementVo.type=AWARD&labSciAchievementVo.ids=${id}"
