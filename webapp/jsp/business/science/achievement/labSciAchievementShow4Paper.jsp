...
html {
	...
	<body class="" id="mainid">
		<form action="" method="post" name="studentForm">
			<input type="hidden" name="labSciAchievementVo.type" value="PAPER"
				id="type" />
																...
																<tr>
																	<td>
																		<l:a
																			...
																			onclick="nextUri('science/labSciAchievement/listLabSciAchievement.action?labSciAchievementVo.type=PAPER');"
																			value="msg.back" />
																	</td>
																</tr>
															</table>
