...
html {
	...
	<body class="" id="mainid">
		<form action="" method="post" name="studentForm">
			...
			<input type="hidden" name="labSciFundsVo.uuid" value="${labSciFundsVo.uuid}" id="uuid" />
																...
																<tr>
																	<td>
																		<l:a uri="science/labSciFunds/listLabScience.action"
																			onclick="nextUri('science/labSciFunds/listLabSciFunds.action?labSciFundsVo.labSciScienceId=${labSciFundsVo.labSciScienceId}&labSciFundsVo.type=0');"
																			value="msg.back" />
																	</td>
																	<td>
											...
											<div class="Formtable">
												...
												<table class="FormtableCon">
													...
													<tr>
														...
														<td>
															<input type="text" name="labSciFundsVo.useDate"
																id="useDate" value="${labSciFundsVo.useDate}" size="40"
																valType="strLength" max="30" strLength-msg=到账时间长度不能超过30位
																" class="Wdate"
													...
													<tr>
														...
														<td>
															<textarea rows="3" cols="40" name="labSciFundsVo.remark"
																...
																strLength-msg='<s:property value="getText('remakrnot512')"/>'>${labSciFundsVo.remark}</textarea>
														</td>
														<td class="r" width="150">
															<label>
														...
														<td colspan="">
															<a id="BtnEdit" class="zPushBtn"
																...
																onclick="uploadFile('${labSciFundsVo.uuid}','lab-scifunds');">
