													...
													<tr>
														<td>
															<l:a uri="science/labSciFunds/listLabScience.action"
																onclick="nextUri('science/labSciFunds/listLabSciFunds.action?labSciFundsVo.labSciScienceId=${labSciFundsVo.labSciScienceId}&labSciFundsVo.type=1');"
																value="msg.back" />
														</td>
														<td>
										...
										<tr>
											...
											<td>
												<input type="text" name="labSciFundsVo.user"
													...
													strLength-msg="支出人长度不能超过32位" msg="支出人不能为空" />
											</td>
											<td class="r" width="150">
												<label>
											...
											<td>
												<input type="text" name="labSciFundsVo.name"
													...
													strLength-msg="支出名称长度不能超过64位" msg="支出名称不能为空" />
											</td>
										</tr>
										<tr>
											<td class="r" width="150">
											...
											<td>
												<input type="text" name="labSciFundsVo.money" id="money"
													...
													strLength-msg="支出金额长度不能超过11位" msg="支出金额不能为空"
													number-msg="支出金额必须为数字" /><s:text name="thousand.yuan"/>
											</td>
											<td class="r" width="150">
												<label>
											...
											<td>
												<input type="text" name="labSciFundsVo.useDate" id="useDate"
													...
													valType="strLength" max="30" strLength-msg="支出时间长度不能超过30位"
													class="Wdate"
