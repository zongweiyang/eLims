	...
	<head>
		...
		<script>
			...
			if(confirm('<s:property value="getText('lab.confirm.delete')"/>')){
				window.location.href='${basePath}science/labSciFunds/deleteLabSciFunds.action?labSciFundsVo.labSciScienceId='+labSciScienceId+'&labSciFundsVo.ids='+id+'&labSciFundsVo.type=1';
			}	
		}
		function deleteBath(){
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr> 
															   <td>
															    ...
															    <td>
																	<l:a uri="science/labSciFunds/preAddLabSciFunds.action?labSciFundsVo.labSciScienceId=${labSciFundsVo.labSciScienceId}&labSciFundsVo.type=1"
																		value="admin.add" />
																</td>
																<td>
										...
										<table class="myworkingboxttable" cellspacing="1"
											...
											<thead>
												<tr>
													...
													<th property="money">
														<s:text name="outer.money"/>(<s:text name="thousand.yuan"/>)
													</th>
													<th property="useDate">
														<s:text name="outer.time"/>
													</th>
													...
													<s:if test="pageResult.resultList!=null">
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="c">
																	<l:a href="#"
																		uri="science/labSciFunds/updateLabSciFunds.action?labSciFundsVo.labSciScienceId=${labSciScienceId}&labSciFundsVo.id=${id}&labSciFundsVo.type=1"
																		onclick="nextUri('science/labSciFunds/preUpdateLabSciFunds.action?labSciFundsVo.labSciScienceId=${labSciScienceId}&labSciFundsVo.id=${id}&labSciFundsVo.type=1');" value="lab.code.modify" />&nbsp;&nbsp;&nbsp;&nbsp;
																	<l:a href="#"
																		uri="science/labSciFunds/deleteLabSciFunds.action?labSciFundsVo.labSciScienceId=${labSciScienceId}&labSciFundsVo.ids=${id}&labSciFundsVo.type=1"
