										...
										<tr>
											...
											<td>
												<input type="text" name="labSciFundsVo.useDate" id="useDate"
													...
													valType="strLength" max="30" strLength-msg="支出时间长度不能超过30位" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true});"/>
											</td>
										</tr>
										<tr>
											<td class="r" width="150">
											...
											<td>
												<textarea rows="4" cols="60" name="labSciFundsVo.remark"
