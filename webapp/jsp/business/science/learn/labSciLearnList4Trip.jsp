	...
	<head>
		...
		function deleteOne(id){
			if(confirm('<s:property value="getText('lab.confirm.delete')"/>')){
				window.location.href='${basePath}science/labSciLearn/deleteLabSciLearn.action?labSciLearnVo.type=3&labSciLearnVo.ids='+id;
			}	
		}
		function deleteBath(){
												...
												<tr>
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
															    <td>
																	<l:a uri="science/labSciLearn/preAddLabSciLearn.action?labSciLearnVo.type=3"
																		value="admin.add" />
																</td>
																<td>
													...
													<s:if test="pageResult.resultList!=null">
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="l">
																	<a href="<%=basePath%>science/labSciLearn/showLabSciLearn.action?labSciLearnVo.type=3&labSciLearnVo.id=${id}">${name}</a>
																</td>
																<td class="l">
																	${labOrgName}
																</td>
																...
																<td class="c">
																    <l:a href="#"
																		uri="science/labSciLearn/preUpdateLabSciLearn.action?labSciLearnVo.type=3&labSciLearnVo.id=${id}"
																		value="lab.code.modify" />
																	<l:a href="#"
																		uri="science/labSciLearn/deleteLabSciLearn.action?labSciLearnVo.type=3&labSciLearnVo.ids=${id}"
