											...
											<div class="Formtable">
												...
												<table class="FormtableCon">
													<tr>
														...
														<td>
															<input type="text" name="labSciLearnVo.name"
																...
																strLength-msg="外出交流长度不能超过64位" msg="外出交流不能为空" />
														</td>
														<td class="r" width="150">
															<label>
													...
													<tr>
														...
														<td>
															<input type="text" name="labSciLearnVo.startTime"
																   ...
																   onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true,minDate:'#F{$dp.$D(\'endTime\')}'});"  valType="required,strLength" max="32"
																   strLength-msg="外出交流时间不能超过32位" msg="外出交流时间不能为空"/><s:text name="to"/>
														...
														<td>
															<input type="text" name="labSciLearnVo.place"
																value="${labSciLearnVo.place}" id="place" size="40"
																valType="required,strLength" max="64"
																strLength-msg="外出交流地点不能超过64位" msg="外出交流地点不能为空" />
														</td>
													</tr>
													<tr>
														<td class="r" width="150">
													...
													<tr>
														...
														<td>
															<textarea rows="3" cols="35" name="labSciLearnVo.labOrgName" id="labOrgName"
																value="${labSciLearnVo.labOrgName}" size="40"  onclick="getOrg();return false;" readonly="true"
														...
														<td>
															<textarea rows="3" cols="35" name="labSciLearnVo.participant"  onclick="getUser();return false;" readonly="true"
													...
													<tr>
														...
														<td>
															<textarea rows="3" cols="35" name="labSciLearnVo.summary"
														...
														<td>
															<textarea rows="3" cols="35" name="labSciLearnVo.remark"
																valType="strLength" max="512"
