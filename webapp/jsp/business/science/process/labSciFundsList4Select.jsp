	...
	<head>
		...
		<script language=javascript> 
			...
			function showLabSciFunds(id)
		  	 	{
			   		var url='<%=basePath%>/science/labSciProcess/showLabSciFunds4Select.action?labSciFundsVo.id='+id;
				   $.dialog({
							id:'processId',
							content:'url:'+url,
										...
										<div class="TabTable">
											<div class="TabTableNAV">
												<ul>
													...
													<li id="li04" class="">
														<a href="javascript:;" onclick="submitvalue('/science/labSciProcess/showLabScience4Process.action?labSciScienceVo.auditResult=tab4');"><span><s:text name="procedure.detail"/></span>
														</a>
													</li>
												</ul>
											</div>
															...
															<s:if test="pageResult.resultList!=null">
																...
																<s:iterator value="#alllist" status="st">
																	<tr>
																		...
																		<td class="c">
																			<l:a href="#" uri="science/labSciProcess/showLabSciFunds4Select.action" onclick="showLabSciFunds('${id }');" value="details.info"/>	
																		</td>
																	</tr>
																</s:iterator>
															</s:if>
