...
<html>
    ...
    function deleteEntity(obj,id,id2){
        ...
        $('#'+id2).attr('rowspan',index); 
   		...
   		function selectPerson(msg)
   	{
   	   var ids=$('#ids').val();
	   var url='/science/labScience/getAllUser.action?messageInfo='+msg;
	   $.dialog({
				id:'userId',
				content:'url:'+url,
							...
							<div class="TabTable">
								<div class="TabTableNAV">
									<ul>
										...
										<li id="li02" class="">
											<a href="javascript:;"
												onclick="submitValue('/science/labSciProcess/showLabScience4Process.action?labSciScienceVo.auditResult=tab2');"><span><s:text name="charge.details"/></span>
											</a>
										</li>
										<li id="li03" class="">
											<a href="javascript:;"
												onclick="submitValue('/science/labSciProcess/showLabScience4Process.action?labSciScienceVo.auditResult=tab3');"><span><s:text name="prj.result"/></span>
											</a>
										</li>
										<li id="li03" class="">
											<a href="javascript:;"
												onclick="submitValue('/science/labSciProcess/showLabScience4Process.action?labSciScienceVo.auditResult=tab4');"><span><s:text name="procedure.detail"/></span>
											</a>
										</li>
									</ul>
								</div>
								<div class="TabTableBOX01 b" id="Tab01">
									...
									<div class="Formtable">
										...
										<div style="display: none;margin-left: 10px;margin-right: 10px;;margin-top: 10px; margin-bottom: 10px;">
											<table class="myworkingboxttable" id="person">
												<thead>
													<th width="18%" class="c">
										...
										<div style="display: none;">
											<table class="FormtableCon_sform" id="funds">
												...
												<tr id="tr0">
                                                    ...
                                                    <td class="r">${money}<input type="hidden" name="labSciScienceVo.labSciFundsList[${ind.index}].money" maxlength="16"  value="${money}" id="money" onblur="getPrice();return false;" max="32" strLength-msg="支出金额长度不能超过32位" number-msg="支出金额必须为数字" msg="支出金额不能为空"/>&nbsp;&nbsp;万元</td>
                                                    <td class="c"> ${user}<input type="hidden" name="labSciScienceVo.labSciFundsList[${ind.index}].user" maxlength="16"  value="${user}" id="user" /></td>
												...
												<tr>
													...
													<td  colspan="3">
														<label id="count" style="margin-left: 230px;color: red;">${labSciScienceVo.outFunds}</label><font color="red">&nbsp;&nbsp;万元</font>
														<input type="hidden" name="labSciScienceVo.applyFunds"
										...
										<div style="display: none;">
											<table class="FormtableCon">
												<tr>
													...
													<td>
														<textarea readonly="readonly" rows="3" cols="40" name="labSciScienceVo.plan"
															valType="strLength"
												...
												<tr>
													...
													<td>
														<textarea readonly="readonly" rows="3" cols="40" name="labSciScienceVo.risk"
															 valType="strLength"
												...
												<tr align="center">
													...
													<td>
														<textarea readonly="readonly" rows="3" cols="40" name="labSciScienceVo.goal"
															valType="strLength"
