				...
				<td id="bodyCell" class="oRight">
					<div class="myworkingbox">
						...
						<form action="" method="post" name="studentForm">
							...
							<input type="hidden" name="messageInfo" value="7" />
							...
							<div class="TabTable">
								<div class="TabTableNAV">
									<ul>
										...
										<li id="li02" class="">
											<a href="javascript:;"
												onclick="goAction('science/labScience/updateLabScience.action?messageInfo=tab2');"><span><s:text name="charge.details"/></span>
											</a>
										</li>
										<li id="li03" class="">
											<a href="javascript:;"
												onclick="goAction('science/labScience/updateLabScience.action?messageInfo=tab3');"><span><s:text name="prj.result"/></span>
											</a>
										</li>
										<li id="li03" class="">
											<a href="javascript:;"
												onclick="goAction('science/labScience/updateLabScience.action?messageInfo=tab4');"><span><s:text name="procedure.detail"/></span>
											</a>
										</li>
									</ul>
								</div>
								<div class="TabTableBOX01 b" id="Tab01">
												...
												<tr align="center">
													...
													<td>
														<textarea rows="2" cols="40"
															...
															max="512" strLength-msg="创新之处不能超过512位" readonly="readonly" >${labSciScienceVo.discovery}</textarea>
													</td>
													<td class="r" width="150">
														达到的目标：
													</td>
													<td>
														<textarea rows="2" cols="40"
															...
															strLength-msg="达到的目标不能超过512位"  readonly="readonly">${labSciScienceVo.quota}</textarea>
													</td>
												</tr>
												<tr>
													<td class="r" width="150">
													...
													<td>
														<textarea rows="2" cols="40" name="labSciScienceVo.meaning"
															...
															max="512" strLength-msg="意义不能超过512位" readonly="readonly" >${labSciScienceVo.meaning}</textarea>
													</td>
													<td class="r" width="150">
														应用前景：
													</td>
													<td>
														<textarea rows="2" cols="40"
															...
															max="512" strLength-msg="应用前景不能超过512位" readonly="readonly" >${labSciScienceVo.prospect}</textarea>
													</td>
												</tr>
												<tr>
													<td class="r" width="150">
													...
													<td colspan="3">
														<textarea rows="2" cols="40" name="labSciScienceVo.problem"
															...
															max="512" strLength-msg="存在的问题不能超过512位" readonly="readonly" >${labSciScienceVo.problem}</textarea>
													</td>
												</tr>
											</table>
										</div>
									...
									<div class="Formtable">
										<div class="Formtabletitle">
											<span><s:text name="itemoveaudinfo"/></span>
											<label style="float: right; padding-right: 10px;"
												onclick="$(this).parent().next().toggle();">
												[&nbsp;
												<font color="blue"><s:text name="open.close"/></font>&nbsp;]
										...
										<div>
											<table class="FormtableCon">
												<tr>
													...
													<td class="l" width="407">
														<input type="radio" style="border: 0" name="labSciScienceVo.auditResult"
													...
													<td>
														<textarea rows="3" cols="40" name="labSciScienceVo.auditMessage"></textarea>
													</td>
												</tr>
											</table>
										</div>
