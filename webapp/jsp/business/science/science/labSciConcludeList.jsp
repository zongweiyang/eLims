...
<html>
	<head>
		...
		<script>
		function getOne(id){
				window.location.href='${basePath}science/labScience/preUpdateLabScience.action?labSciScienceVo.id='+id+'&messageInfo=6';
		}
													...
													<s:if test="pageResult.resultList!=null">
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="c">
																	<l:a href="#"
																		uri="science/labScience/preUpdateLabScience.action?labSciScienceVo.id=${id}&messageInfo=6"
																		onclick="getOne('${id}');" value="lanchover" />
																	<a
