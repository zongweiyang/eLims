						...
						<form action="" method="post" name="studentForm">
							...
							<input type="hidden" name="labSciScienceVo.processInsId"
								value="${labSciScienceVo.processInsId}" />
									<input type="hidden" name="messageInfo" value="3" />
										...
										<td class="blockTd"
											...
											<table cellspacing="0" cellpadding="0" border="0">
												<tr>
													...
													<td>
														<l:a
															uri="science/labScience/updateLabSciScience4Audit.action"
															value="post.commit" />
													</td>
												</tr>
											</table>
							...
							<!-- <div class="TabTable">
								...
								<div class="TabTableBOX01 b" id="Tab01">
												...
												<tr>
													...
													<td  colspan="2">
														...
														<input type="hidden" name="labSciScienceVo.applyFunds"
																	maxlength="16" value="${labSciScienceVo.applyFunds}"
									...
									<div class="Formtable">
										<div class="Formtabletitle">
											<span><s:text name="itemauditinfo"/></span>
											<label style="float: right; padding-right: 10px;"
												onclick="$(this).parent().next().toggle();">
												[&nbsp;
												<font color="blue"><s:text name="open.close"/></font>&nbsp;]
										...
										<table class="FormtableCon">
											<tr>
												...
												<td>
													<input style="border: 0px;" type="radio" name="labSciScienceVo.auditResult"
