...
<html>
	<head>
		...
		<script>
		function getOne(id){
				window.location.href='${basePath}science/labScience/preUpdateLabScience.action?labSciScienceVo.id='+id+'&messageInfo=3';
		}
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="c">
																	...
																	<s:if test="${status=='立项审批'}">
																	&nbsp;&nbsp;
																	<l:a href="#"
																		uri="science/labScience/preUpdateLabScience.action?labSciScienceVo.id=${id}&messageInfo=3"
																		onclick="getOne('${id}');" value="审批" />
																	</s:if>
																</td>
															</tr>
														</s:iterator>
