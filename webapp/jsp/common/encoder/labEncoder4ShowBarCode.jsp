									...
									<div class="myworkingbox" style="min-height: 100px;">
										...
										<div id="printDiv">
											<table class="myworkingboxttable" cellspacing="1" cellpadding="0">
													...
													<tr id="">
														<td class="ewm">
															<img src="<%=basePath%>gensvg?type=code128&msg=<%=encoderVo.getId() %>&height=<%=encoderVo.getSize4One() %>&hrp=<%=encoderVo.getNumLay4One() %>&fmt=png&res=200&gray=true" style="margin-top: 6px; margin-bottom: 6px; height: 80px; width: 280px;" />
														</td>
													</tr>
											</table>
										</div>
