...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		int length=0;
		String isContent=encoderVo.getIsContentEwm();
...
<script>
	...
	function CreatePrintPage() {
		...
		var j = 0;
		for(i=0;i<size;i++){
			var html ='<div style="border:1px solid;height:165px;width:260px;"><table cellspacing="0" cellpadding="0" style="margin:10;padding:0;">';
			if(isContent=='Y'){
