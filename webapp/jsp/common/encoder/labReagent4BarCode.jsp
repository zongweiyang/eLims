										...
										<div id="printDiv">
											<table class="myworkingboxttable" cellspacing="1" cellpadding="0">
												<s:if test="labEncoderVo.barCodeList!=null">
													...
													<tr id="">
														<td class="ewm">
															<img src="<%=basePath%>gensvg?type=code128&msg=<%=barCode.getId() %>&height=2cm&hrp=bottom&fmt=png&res=200&gray=true" style="margin-top: 6px; margin-bottom: 6px; height: 80px; width: 280px;" />
														</td>
													</tr>
													<%
														}
