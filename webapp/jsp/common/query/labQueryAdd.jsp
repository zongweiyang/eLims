								...
								<div class="Formtable">
									...
									<table class="FormtableCon">
										<tr>
											...
											<td>
												<s:select list="#request.listLabFunction" cssStyle="width:153px" headerKey="0" headerValue="" onchange="checkFun(this)" theme="simple" listValue="name" listKey="id+'|'+name"></s:select>
