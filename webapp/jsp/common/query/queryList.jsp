		...
		<script language="JavaScript">
			function submitvalue(actionstr){
		  	...
		  	function doAction(page){
		  		...
		  		$("#pages").val(pageNum);
		  		submitvalue('/query/labQuery/getQuery.action');
		  	}
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																		<td><a id="BtnPreview" class="zPushBtn" href="javascript:void(0);" onclick="submitvalue('/query/labQuery/getQuery.action'); return false;"><img height="20" width="20" src="${basePath}img/chakan.gif"/><b><s:text name="fun.query"/></b></a></td>
																</td>
															</tr>
														</table>
													</td>
