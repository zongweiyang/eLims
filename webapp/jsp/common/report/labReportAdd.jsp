								...
								<div class="Formtable">
									...
									<table class="FormtableCon">
										<tr>
											...
											<td>
												<input type="text" name="labReportVo.title" valType="required,strLength" max="32" msg="名称不能为空" strLength-msg="长度不能超过32位" id="title" value="${labReportVo.title}" size="30" />
											</td>
											<td>
												<label>
										...
										<tr>
											...
											<td>
												<s:select list="#request.funcList" listKey="id+'^'+wfcode" listValue="name" theme="simple" cssStyle="width:176px;" headerKey="" headerValue="-请选择-" onchange="getWfProcessCode(this);"></s:select>
