											...
											<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														...
														<td>
															<l:a uri="report/labReport/addLabReport.action" onclick="submitvalue('report/labReport/addLabReport.action');return false;" value="lab.code.save" />
														</td>
													</tr>
												</table>
											</td>
								...
								<div class="Formtable">
									...
									<table class="FormtableCon">
										<tr>
											...
											<td>
												<input type="text" name="labReportVo.title" valType="required,strLength" max="32" msg='<s:property value="getText('lab.msg.name')"/>' strLength-msg='<s:property value="getText('lab.strlength.msg')"/>' id="title" value="${labReportVo.title}" size="30" />
											</td>
											<td>
												<label>
										...
										<tr>
											...
											<td>
												<s:select list="#request.funcList" listKey="id+'^'+wfcode" listValue="name" theme="simple" cssStyle="width:176px;" headerKey="" headerValue="" onchange="getWfProcessCode(this);"></s:select>
