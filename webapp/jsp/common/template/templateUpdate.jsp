				...
				<td id="bodyCell" class="oRight">
					<div class="myworkingbox">
						...
						<form action="" method="post" id="templateForm" name="templateForm" theme="simple">
							<input type="hidden" name="labTemplateVo.id" value="${labTemplateVo.id}" />
							<div>
											...
											<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														...
														<td>
															<l:a uri="template/labTemplate/updateLabTemplate.action" onclick="submitvalue('template/labTemplate/updateLabTemplate.action');" value="lab.code.modify" />
														</td>
													</tr>
												</table>
											</td>
