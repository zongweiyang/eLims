							...
							<s:form theme="simple" action="" method="post" name="labAmbientForm">
								...
								<div class="TabTable">
								 	<div class="FUNCIONBARNEW">
				                      ...
				                      <td><a id="BtnPreview" class="zPushBtn" href="javascript:;" onclick="submitvalue('updateLabAmbient.action');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif"/><b><s:text name="lab.code.save"/></b></a></td>
				                      </tr></table></td></tr>
				                      </table>
			                    	</div>
									<div class="Formtable">
