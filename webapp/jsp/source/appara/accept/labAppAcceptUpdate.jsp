													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabAppAccept.action?labApparaAcceptVo.auditResult=0');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="lab.code.save"/></b> </a>
																</td>
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabAppAccept.action?labApparaAcceptVo.auditResult=1');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/> </a>
																</td>
															</tr>
														</table>
													</td>
											...
											<table id="tableId" class="tabtableboxtable" width="80%" cellpadding="1" cellspacing="1">
												<tr>
													...
													<td align="left">
														...
														<input name="labApparaAcceptVo.appName" readonly="readonly" value="${labApparaAcceptVo.appName}" id="appName" type="text" size="30" />
													</td>
													<td align="right">
														<label>
													...
													<td align="left">
														<input name="labApparaAcceptVo.spec" readonly="readonly" value="${labApparaAcceptVo.spec}" id="specification" type="text" size="30" />
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td align="left">
														<input name="labApparaAcceptVo.appNo" readonly="readonly" value="${labApparaAcceptVo.appNo}" id="price" type="text" size="30" />
													</td>
													<td align="right">
														<label>
													...
													<td align="left">
														<input name="labApparaAcceptVo.price" readonly="readonly" value="${labApparaAcceptVo.price}" id="price" type="text" size="30" />
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td align="left" colspan="4">
														<input name="labApparaAcceptVo.manufact" readonly="readonly" value="${labApparaAcceptVo.manufact}" id="manufacturer" type="text" size="30" />
													</td>
												</tr>
												<tr>
