...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="" id="mainid" style="overflow-y: auto; height: 100%">
		<form action="" method="post" name="labAppAccpetForm" theme="simple">
				...
				<tr>
					...
					<td id="bodyCell" class="oRight">
						<table class="workingBody" cellspacing="0" cellpadding="0" border="0">
								...
								<td>
									<div class="myworkingbox">
										<div class="myworkingboxttitle">
											<h2>
												${funName }：
												<span><s:text name="checking.appr"/></span>
											</h2>
										</div>
													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<input name="labApparaAcceptVo.appName" id="name" value="${labApparaAcceptVo.appName}" type="text" />
																</td>
																<td>
																	<label>
																		<s:text name="app.no"/>：
																...
																<td>
																	<l:a uri="appara/accept/listAppAcceptAudit.action" value="fun.query" />
																</td>
															</tr>
														</table>
													</td>
														...
														<s:iterator value="#alllist" status="st">
															...
															<tr>
																...
																<td class="c">
																	...
																	<s:else>
																		<l:a href="#" uri="appara/accept/showLabAppAccept.action?labApparaAcceptVo.id=${id}" value="look.check" />
																		<l:a href="#" uri="appara/accept/preUpdateAppAcceptAudit.action?labApparaAcceptVo.id=${id}" value="flow.check" />
																	</s:else>
																</td>
															</tr> 
														</s:iterator>
							...
							<tr>
								<td align="center"><jsp:include page="/jsp/include/page.jsp?formName=labAppAccpetForm" flush="true" /></td>
							</tr>
						</table>
					</td>
				</tr>
