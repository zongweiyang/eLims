								...
								<td>
									<div class="myworkingbox">
										<div class="myworkingboxttitle">
											<h2>
												${funName }：
												<span><s:text name="bor.red.list"/></span>
											</h2>
										</div>
												...
												<tr>
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															...
															<tr>
																<td>
																	<l:a uri="appara/borrow/preAddLabApparaBor.action" value="lab.code.add" />
																</td>
															</tr>
														</table>
													</td>
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="c">
																	...
																	<s:else>
																		<l:a href="#" uri="appara/borrow/showLabApparaBor.action?labApparaBorVo.id=${id }" value="look.check" />
																		<l:a href="#" uri="appara/borrow/preUpdateLabApparaBor.action?labApparaBorVo.id=${id }" value="theme.modify" />
																	</s:else>
																</td>
															</tr>
														</s:iterator>
