													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabApparaBorPaudit.action');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/></b> </a>
																</td>
															</tr>
														</table>
													</td>
											...
											<table id="tableId" class="FormtableCon">
												<tr>
													...
													<td align="left" colspan="3">
														...
														<input name="labApparaBorVo.appName" readonly="readonly" value="${labApparaBorVo.appName}" id="appName" type="text" size="80"  />
														<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;*</font>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td align="left" colspan="3">
														<textarea cols="70" rows="6" readonly="readonly" name="labApparaBorVo.view2" id="view2" size="80">${labApparaBorVo.view2}</textarea>
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td align="left">
														<input name="labApparaBorVo.user2" readonly="readonly" value="${labApparaBorVo.user2}" id="user2" type="text" size="20" />
													</td>
													<td align="right">
														<label>
															<s:text name="msg.date"/>：
													...
													<td align="left">
														<input name="labApparaBorVo.date2" readonly="readonly" value="${labApparaBorVo.date2}" id="date2" type="text" size="20" class="Wdate" onfocus="WdatePicker({})" />
													</td>
												</tr>
											</table>
										</div>
										<div class="Formtable">
											...
											<table class="FormtableCon">
												...
												<tr>
													...
													<td align="left" colspan="3">
														<textarea cols="70" rows="6" name="labApparaBorVo.view3" id="view3" size="80">${labApparaBorVo.view3}</textarea>
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td align="left">
														<input name="labApparaBorVo.user3" value="${labApparaBorVo.user3}" readonly="true" id="user3" type="text" size="20" />
													</td>
													<td align="right">
														<label>
															<s:text name="msg.date"/>：
													...
													<td align="left">
														<input name="labApparaBorVo.date3" value="${labApparaBorVo.date3}" readonly="true" id="date3" type="text" size="20" class="Wdate" onfocus="WdatePicker({})" />
													</td>
												</tr>
											</table>
										</div>
