													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabApparaBor.action?labApparaBorVo.auditResult=0');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="lab.code.save"/></b></a>
																</td>
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabApparaBor.action?labApparaBorVo.auditResult=1');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/></b></a>
																</td>
															</tr>
														</table>
													</td>
											...
											<table id="tableId" class="FormtableCon" >
												<tr>
													...
													<td align="left" colspan="3">
														...
														<input name="labApparaBorVo.appName" value="${labApparaBorVo.appName}" id="appName" type="text" size="80" onclick="showApp();" valType="required" msg="请选择仪器" readonly="true"/>
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td align="left" colspan="3">
														<input name="labApparaBorVo.appNo" value="${labApparaBorVo.appNo}" id="appNo" type="text" size="80" readonly="true"/>
														<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;*</font>
													</td>
												</tr>
												<tr>
