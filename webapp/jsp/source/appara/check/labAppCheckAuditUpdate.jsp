										...
										<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
											<table cellspacing="0" cellpadding="0" border="0">
												<tr>
													...
													<td>
														<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabApparaCheckAudit.action');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /> <b><s:text name="save.commit"/></b> </a>
													</td>
												</tr>
											</table>
										</td>
							...
							<div class="Formtable" style="margin-top: 0px;">
								...
								<table id="tableId" class="FormtableCon">
									<tr>
										...
										<td colspan="2">
											<input type="text" size="30" name="labApparaCheckVo.appName" readonly="readonly" value="${labApparaCheckVo.appName}" >
											<input type="hidden" name="labApparaCheckVo.id" value="${labApparaCheckVo.id }" />
											<input type="hidden" name="labApparaCheckVo.appId" value="${labApparaCheckVo.appId}" />
										</td>
										<td class="w100">
								...
								<table class="FormtableCon">
									...
									<tr>
										...
										<td align="left" colspan="3">
											<textarea cols="70" rows="6" name="labApparaCheckVo.auditMessage" id="auditMessage" size="80">${labApparaCheckVo.auditMessage}</textarea>
										</td>
									</tr>
									<tr>
										<td align="right">
										...
										<td align="left">
											<input name="labApparaCheckVo.user2" value="${labApparaCheckVo.user2}" readonly="true" id="user2" type="text" size="20" />
										</td>
										<td align="right">
											<label>
										...
										<td align="left">
											<input name="labApparaCheckVo.date2" value="${labApparaCheckVo.date2}" readonly="true" id="date2" type="text" size="20" class="Wdate" onfocus="WdatePicker({})" />
										</td>
									</tr>
								</table>
							</div>
