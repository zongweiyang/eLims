													...
													<center>
														...
														<table id="tableId" class="myworkingboxttable12" cellpadding="0" cellspacing="0">
															<tr>
																...
																<td colspan="2">
																	${labApparaCheckVo.appName}
																</td>
																<td class="w100">
																	<s:text name="check.datetime"/>：
																</td>
																<td colspan="2">
																	${labApparaCheckVo.verDate}
																</td>
															</tr>
															<tr>
																<td class="w100" style="height: 100px;">
																	<s:text name="check.methods"/>：
																</td>
																<td colspan="2">
																	${labApparaCheckVo.ext05 }
																</td>
																<td class="w100">
																	<s:text name="checker"/>：
																</td>
																<td colspan="2">
																	${labApparaCheckVo.checkName}
																</td>
															</tr>
															<tr>
																<td class="w100">
															...
															<tr>
																...
																<td align="left" colspan="5" style="height: 100px;">
																	${labApparaCheckVo.auditMessage}
																</td>
															</tr>
															<tr>
																<td align="right">
															...
															<tr>
																...
																<td align="left" colspan="5" style="height: 100px;">
																	${labApparaCheckVo.pauditMessage}
																</td>
															</tr>
															<tr>
																<td align="right">
