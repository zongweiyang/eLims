											...
											<table id="tableId" class="FormtableCon">
												<tr>
													...
													<td align="left" colspan="3">
														...
														<input name="labApparaDropVo.appName" value="${labApparaDropVo.appName}" readonly="readonly" id="appName" type="text" size="80" />
														<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;*</font>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td align="left">
														<input name="labApparaDropVo.date1" readonly="readonly" value="${labApparaDropVo.date1}" id="date1" type="text" size="20" class="Wdate" onfocus="WdatePicker({})" />
													</td>
												</tr>
											</table>
										</div>
										<div class="Formtable">
											...
											<table class="FormtableCon">
												...
												<tr>
													...
													<td align="left" colspan="3">
														<textarea cols="70" rows="6" name="labApparaDropVo.view2" id="view2" size="80">${labApparaDropVo.view2}</textarea>
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td align="left">
														<input name="labApparaDropVo.user2" value="${labApparaDropVo.user2}" id="user2" type="text" size="20" readonly="true"/>
													</td>
													<td align="right">
														<label>
															<s:text name="msg.date"/>：
													...
													<td align="left">
														<input name="labApparaDropVo.date2" value="${labApparaDropVo.date2}" id="date2" type="text" size="20" class="Wdate" readonly="true" onfocus="WdatePicker({})" />
													</td>
												</tr>
											</table>
										</div>
