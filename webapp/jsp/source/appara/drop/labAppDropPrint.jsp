														...
														<table>
															<tr>
																<td style="font-size: 20px; font-weight: 800;">
																	<s:text name="app.droped.list.doc"/>
																</td>
															</tr>
														</table>
