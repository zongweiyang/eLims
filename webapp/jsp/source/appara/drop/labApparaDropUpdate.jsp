													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('upDateLabApparaDrop.action?labApparaDropVo.auditResult=0');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="lab.code.save"/></b> </a>
																</td>
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('upDateLabApparaDrop.action?labApparaDropVo.auditResult=1');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/></b> </a>
																</td>
															</tr>
														</table>
													</td>
											...
											<table id="tableId" class="FormtableCon" >
												<tr>
													...
													<td align="left" colspan="3">
														<input name="labApparaDropVo.appId" id="appId" type="hidden" value="${labApparaDropVo.appId}" size="80" />
														<input name="labApparaDropVo.id" id="id" type="hidden" value="${labApparaDropVo.id}" size="80" />
														<input name="labApparaDropVo.appName" value="${labApparaDropVo.appName}" id="appName" type="text" size="80" onclick="showApp()" readonly="true" valType="required" msg="请选择仪器"/>
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td align="left" colspan="3">
														<input name="labApparaDropVo.appNo" value="${labApparaDropVo.appNo}" readonly="true" id="appNo" type="text" size="80" />
														<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;*</font>
													</td>
												</tr>
												<tr>
