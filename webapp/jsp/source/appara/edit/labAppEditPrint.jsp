													...
													<center>
														...
														<table id="tableId" class="myworkingboxttable12" cellpadding="0" cellspacing="0">
															<tr>
																...
																<td colspan="2">
																	${labApparaEditVo.appName}
																</td>
																<td class="w100">
																	<s:text name="msg.date"/>：
																</td>
																<td colspan="2">
																	${labApparaEditVo.verDate}
																</td>
															</tr>
															<tr>
																<td class="w100">
																...
																<td colspan="2">
																	${labApparaEditVo.auditName}
																</td>
																<td class="w100">
																	<s:text name="saved.repair.man"/>：
																</td>
																<td colspan="2">
																	${labApparaEditVo.checkName}
																</td>
															</tr>
															<tr>
																<td class="w100">
