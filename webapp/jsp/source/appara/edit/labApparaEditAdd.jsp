										...
										<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
											<table cellspacing="0" cellpadding="0" border="0">
												<tr>
													...
													<td>
														<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('addLabApparaEdit.action?labApparaEditVo.auditResult=0');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="lab.code.save"/></b> </a>
													</td>
													<td>
														<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('addLabApparaEdit.action?labApparaEditVo.auditResult=1');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/></b> </a>
													</td>
												</tr>
											</table>
										</td>
								...
								<table id="tableId" class="FormtableCon">
									<tr>
										...
										<td colspan="2">
											...
											<input type="hidden" id="appId" value="${labApparaEditVo.appId}" name="labApparaEditVo.appId"  valType="required" msg="请选择仪器" readonly="true">
										...
										<td colspan="2">
											<input id="verificationTime" name="labApparaEditVo.verDate" value="${labApparaEditVo.verDate}" size="30" class="Wdate" type="text" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'verificationTime\')||\'2020-10-01\'}'})" valType="required" msg="请填写维修日期!"/>
										</td>
									</tr>
									<tr>
										<td class="w100">
