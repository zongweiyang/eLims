										...
										<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
											<table cellspacing="0" cellpadding="0" border="0">
												<tr>
													...
													<td>
														<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabApparaEditPaudit.action');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/></b> </a>
													</td>
												</tr>
											</table>
										</td>
								...
								<table id="tableId" class="FormtableCon" >
									<tr>
										...
										<td colspan="2">
											...
											<input type="hidden" id="spec" value="${labApparaEditVo.appSpec}" name="labApparaEditVo.appSpec">
										</td>
										<td class="w100">
									...
									<tr>
										...
										<td align="left">
											<input name="labApparaEditVo.user2" value="${labApparaEditVo.user2}" id="user2" type="text" size="20" />
										</td>
										<td align="right">
											<label>
												<s:text name="msg.date"/>：
										...
										<td align="left">
											<input name="labApparaEditVo.date2" value="${labApparaEditVo.date2}" id="date2" type="text" size="20" class="Wdate" onfocus="WdatePicker({})" />
										</td>
									</tr>
								</table>
							</div>
							<div class="Formtable">
								...
								<table class="FormtableCon">
									...
									<tr>
										...
										<td align="left" colspan="3">
											<textarea cols="70" rows="6" name="labApparaEditVo.pauditMessage" id="pauditMessage" size="80">${labApparaEditVo.pauditMessage}</textarea>
										</td>
									</tr>
									<tr>
										<td align="right">
										...
										<td align="left">
											<input name="labApparaEditVo.user3" readonly="true" value="${labApparaEditVo.user3}" id="user3" type="text" size="20" />
										</td>
										<td align="right">
											<label>
												<s:text name="msg.date"/>：
										...
										<td align="left">
											<input name="labApparaEditVo.date3" readonly="true" value="${labApparaEditVo.date3}" id="date3" type="text" size="20" class="Wdate" onfocus="WdatePicker({})" />
										</td>
									</tr>
								</table>
							</div>
