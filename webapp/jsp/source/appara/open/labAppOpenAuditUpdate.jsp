													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabApparaOpenAudit.action');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/></b> </a>
																</td>
															</tr>
														</table>
													</td>
											...
											<table id="tableId" class="FormtableCon" >
												<tr>
													...
													<td align="left" colspan="3">
														...
														<input name="labApparaOpenVo.appName" readonly="readonly" value="${labApparaOpenVo.appName}" id="appName" type="text" size="80" />
														<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;*</font>
													</td>
												</tr>
												<tr>
										...
										<div class="Formtable">
												...
												<table class="FormtableCon">
													...
													<tr>
														...
														<td align="left" colspan="3">
															<textarea cols="70" rows="6" name="labApparaOpenVo.view2" id="view2" size="80">${labApparaOpenVo.view2}</textarea>
														</td>
													</tr>
													<tr>
														<td align="right">
														...
														<td align="left">
															<input name="labApparaOpenVo.user2" value="${labApparaOpenVo.user2}" readonly="true" id="user2" type="text" size="20" />
														</td>
														<td align="right">
															<label>
																<s:text name="msg.date"/>：
														...
														<td align="left">
															<input name="labApparaOpenVo.date2" value="${labApparaOpenVo.date2}" readonly="true" id="date2" type="text" size="20" class="Wdate" onfocus="WdatePicker({})" />
														</td>
													</tr>
												</table>
											</div>
