...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript"
			src="<%=basePath%>utils/My97DatePicker/WdatePicker.js"></script>
		<script type="text/javascript">
	...
	<body class="" id="mainid" style="overflow-y: auto; height: 100%">
		<form action="" method="post" name="customeractivitiesForm"
			theme="simple">
			<table id="bodyTable" class="bodytable" width="100%" cellspacing="0"
								...
								<td>
									<div class="myworkingbox">
										<div class="myworkingboxttitle">
											<h2>
												${funName }：
												<span><s:text name="start.list.app"/></span>
											</h2>
										</div>
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<input id="name" name="labApparaOpenVo.appName"
																		value="${labApparaOpenVo.appName}" type="text" />
																</td>
																<td>
																	<label>
																...
																<td>
																	<l:a uri="appara/open/listLabApparaOpen.action"
																		value="fun.query" />
																</td>
															</tr>
														</table>
												...
												<tr>
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																<td>
																	<l:a uri="appara/open/preAddLabApparaOpen.action"
																		value="lab.code.add" />
																</td>
															</tr>
														</table>
														...
														<s:iterator value="#alllist" status="st">
															...
															<tr>
																...
																<td class="c">
																	<s:if test="${isOper == 'N'}">
																		<l:a href="#"
																			uri="appara/open/showLabAppOpen.action?labApparaOpenVo.id=${id}"
																			value="look.check" />
																	</s:if>
																	<s:else>
																		<l:a href="#"
																			...
																			value="look.check" />
																		<l:a href="#"
																			uri="appara/open/preUpdateAppOpen.action?labApparaOpenVo.id=${id}"
																			value="theme.modify" />
																	</s:else>
																</td>
															</tr>
				...
				<tr>
					<td align="center"><jsp:include
							page="/jsp/include/page.jsp?formName=customeractivitiesForm"
							flush="true" /></td>
				</tr>
			</table>
		</form>
