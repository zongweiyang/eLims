								...
								<td>
									<div class="myworkingbox">
										<div class="myworkingboxttitle">
											<h2>
												${funName }：
												<span><s:text name="falut.audit.list"/></span>
											</h2>
										</div>
													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a uri="/appara/listApparaProvAudit.action" value="fun.query" />
																</td>
															</tr>
														</table>
													</td>
													...
													<s:if test="pageResult.resultList!=null">
														...
														<s:iterator value="#alllist" status="st">
															...
															<tr>
																...
																<td class="c">
																	<s:if test="${isOper == 'Y'}">
																		<l:a href="#" uri="appara/prov/preUpdateApparaProv4Audit.action?labApparaProvVo.id=${id}" value="flow.check" />
																	</s:if>
																	<s:else>
