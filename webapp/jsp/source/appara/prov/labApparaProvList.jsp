								...
								<td>
									<div class="myworkingbox">
										<div class="myworkingboxttitle">
											<h2>
												${funName }：
												<span><s:text name="app.fault.rec"/></span>
											</h2>
										</div>
													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a uri="/appara/listApparaProv.action" value="fun.query" />
																</td>
															</tr>
														</table>
													</td>
												...
												<tr>
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																<td>
																	<l:a uri="appara/prov/preAddLabApparaProv.action" value="lab.code.add" />
																</td>
															</tr>
														</table>
													</td>
													...
													<s:if test="pageResult.resultList!=null">
														...
														<s:iterator value="#alllist" status="st">
															...
															<tr>
																...
																<td class="c">
																	<s:if test="${isOper == 'Y'}">
																		<l:a href="#" uri="appara/prov/preUpdateAppProv.action?labApparaProvVo.id=${id}" value="theme.modify" />
