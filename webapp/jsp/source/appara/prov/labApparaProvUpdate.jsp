									...
									<tr>
										<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
											<table cellspacing="0" cellpadding="0" border="0">
												<tr>
													<td>
														<a id="BtnPreview" class="zPushBtn" onclick="backList();return false;"><img height="20" width="20" src="<%=basePath%>img/fanhui.gif" /><b><s:text name="msg.back"/></b>
														</a>
													</td>
													<td>
														<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabApparaProv.action?labApparaProvVo.auditResult=0');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="lab.code.save"/></b>
														</a>
													</td>
													<td>
														<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabApparaProv.action?labApparaProvVo.auditResult=1');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/></b>
														</a>
													</td>
												</tr>
											</table>
							...
							<div class="Formtable">
								...
								<table id="tableId" class="FormtableCon" >
									<tr>
										...
										<td colspan="2">
											<input type="text" id="appName" value="${labApparaProvVo.labAppName}" name="labApparaProvVo.labAppName" onclick="showApp()" size="30" valType="required" msg="请选择仪器" readonly="true">
											<input type="hidden" id="appId" value="${labApparaProvVo.labAppId}" name="labApparaProvVo.labAppId">
											<input type="hidden" id="specification" value="${labApparaProvVo.spec}" name="labApparaProvVo.spec">
											<input type="hidden" id="appNo" value="${labApparaProvVo.labAppNo}" name="labApparaProvVo.labAppNo">
										</td>
										<td width="150">
									...
									<tr>
										...
										<td colspan="2" >
											<input name="labApparaProvVo.checkName" value="${labApparaProvVo.checkName}" type="text" id="labApparaProvVo.checkName">
										</td>
									</tr>
									<tr>
										<td width="150">
