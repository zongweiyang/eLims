													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('addLabApparaStop.action?labApparaStopVo.auditResult=0');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="lab.code.save"/></b> </a>
																</td>
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('addLabApparaStop.action?labApparaStopVo.auditResult=1');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/></b> </a>
																</td>
															</tr>
														</table>
													</td>
											...
											<table id="tableId" class="FormtableCon">
												<tr>
													...
													<td align="left" colspan="3">
														...
														<input name="labApparaStopVo.appName" value="${labApparaStopVo.appName}" id="appName" readonly="true" type="text" size="80"  valType="required" msg="请选择仪器" onclick="showApp();return false;" />
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td align="left" colspan="3">
														<input name="labApparaStopVo.appNo" value="${labApparaStopVo.appNo}" id="appNo" type="text" size="80" readonly="true" valType="required" msg="请填写编号!"/>
													</td>
												</tr>
												<tr>
													<td align="right">
