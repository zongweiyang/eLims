													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateAppStop.action');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/></b> </a>
																</td>
															</tr>
														</table>
													</td>
											...
											<table id="tableId" class="FormtableCon">
												<tr>
													...
													<td align="left" colspan="3">
														...
														<input name="labApparaStopVo.appName" readonly="readonly" value="${labApparaStopVo.appName}" id="appName" type="text" size="80" onclick="showApp()" />
														<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;*</font>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td align="left">
														<input name="labApparaStopVo.user1" readonly="true" value="${labApparaStopVo.user1}" id="user1" type="text" size="20" />
													</td>
													<td align="right">
														<label>
													...
													<td align="left">
														<input name="labApparaStopVo.date1" readonly="true" value="${labApparaStopVo.date1}" id="date1" type="text" size="20" class="Wdate" onfocus="WdatePicker({})" />
													</td>
												</tr>
											</table>
										</div>
										<div class="Formtable">
											...
											<table class="FormtableCon">
												...
												<tr>
													...
													<td align="left" colspan="3">
														<textarea cols="70" rows="6" name="labApparaStopVo.view2" id="view2" size="80">${labApparaStopVo.view2}</textarea>
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td align="left">
														<input name="labApparaStopVo.user2" value="${labApparaStopVo.user2}" id="user2" readonly="true" type="text" size="20" />
													</td>
													<td align="right">
														<label>
															<s:text name="msg.date"/>：
													...
													<td align="left">
														<input name="labApparaStopVo.date2" value="${labApparaStopVo.date2}" id="date2" readonly="true" type="text" size="20" class="Wdate" onfocus="WdatePicker({})" />
													</td>
												</tr>
											</table>
										</div>
