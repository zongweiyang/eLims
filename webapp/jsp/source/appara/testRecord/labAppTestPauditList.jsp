								...
								<td>
									<div class="myworkingbox">
										<div class="myworkingboxttitle">
											<h2>
												<s:text name="appmanage"/>:
												<span><s:text name="app.ck.apr.list"/></span>
											</h2>
										</div>
													...
													<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a uri="appara/open/listLabAppTestPaudit.action" value="fun.query" />
																</td>
															</tr>
														</table>
													</td>
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																...
																<td class="c">
																	...
																	<s:else>
																		<l:a href="#" uri="appara/test/showLabApparaTest.action?labApparaTestVo.id=${id}" value="look.check" />
																		<l:a href="#" uri="appara/test/preUpdateLabAppTestPaudit.action?labApparaTestVo.id=${id}" value="flow.check" />
																	</s:else>
																</td>
															</tr>
														</s:iterator>
