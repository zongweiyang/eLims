													...
													<center>
														...
														<table id="tableId" class="myworkingboxttable12" cellpadding="0" cellspacing="0">
															...
															<tr>
																...
																<td colspan="2">
																	${labApparaTestVo.reposPerson}
																</td>
																<td class="w100">
																	<s:text name="send.check"/>：
																</td>
																<td colspan="2">
																	${labApparaTestVo.ext01}
																</td>
															</tr>
															<tr>
