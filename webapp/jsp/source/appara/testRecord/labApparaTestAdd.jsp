										...
										<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
											<table cellspacing="0" cellpadding="0" border="0">
												<tr>
													...
													<td>
														<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('addLabApparaTest.action?labApparaTestVo.auditResult=0');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="lab.code.save"/></b> </a>
													</td>
													<td>
														<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('addLabApparaTest.action?labApparaTestVo.auditResult=1');return false;"><img height="20" width="20" src="<%=basePath%>img/add.gif" /><b><s:text name="save.commit"/></b> </a>
													</td>
												</tr>
											</table>
										</td>
							...
							<div class="Formtable" style="margin-top: 0px;">
								...
								<table id="tableId" class="FormtableCon" >
									<tr>
										...
										<td colspan="2">
											<input name="labApparaTestVo.appName" value="${labApparaTestVo.appName}" type="text" valType="required" msg="请选择仪器" readonly="true" onclick="showApp();return false;" id="appName">
										...
										<td colspan="2">
											<input id="testDate" name="labApparaTestVo.testDate" value="${labApparaTestVo.testDate}" readonly="true" size="30" class="Wdate" type="text" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'testDate\')||\'2020-10-01\'}'})" valType="required" msg="请填写检定日期!" />
										</td>
										</td>
									</tr>
									<tr>
