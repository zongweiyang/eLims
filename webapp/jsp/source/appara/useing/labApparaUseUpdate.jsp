										...
										<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
											<table cellspacing="0" cellpadding="0" border="0">
												<tr>
													...
													<td>
														<a id="BtnPreview" class="zPushBtn" href="#" onclick="submitvalue('updateLabAppUse.action');return false;"><img height="20" width="20" src="<%=basePath%>img/update.gif" /><b><s:text name="post.commit"/></b> </a>
													</td>
												</tr>
											</table>
										</td>
							...
							<div class="Formtable">
								...
								<table id="tableId" class="FormtableCon">
									...
									<tr>
										...
										<td>
											<input name="labApparaUseVo.beStartDate" readonly="readonly" id="beStartDate" value="${labApparaUseVo.beStartDate}" type="text" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true,maxDate:'#F{$dp.$D(\'beEndDate\')}'});"/>
										</td>
										<td>
											<s:text name="pre.endtime"/>：
										</td>
										<td>
											<input name="labApparaUseVo.beEndDate" readonly="readonly" id="beEndDate" value="${labApparaUseVo.beEndDate}" type="text" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true,minDate:'#F{$dp.$D(\'beStartDate\')}'});"/>
										</td>
									</tr>
									<tr>
										<td>
