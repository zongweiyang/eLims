...
html {
	...
	var api = frameElement.api, W = api.opener, D = W.document; // api.opener 为载加lhgdialog.min.js文件的页面的window对象
		...
		function submitvalueforlist(){
			...
			df.action=basePath+"consumables/labConsumables/updateLabConsumablesMove.action?labConsumablesVo.consumablesTypeId="+funIds;
		    df.submit();
		    closeMe();
		}
	...
	<body class="" id="mainid" style="overflow-y: auto;">
		<div id="popup">
			<form name="listForm" action="#" method="post" target="workarea">
				<input type="hidden" value="${labConsumablesVo.id}"
					id="labConsumablesId" name="labConsumablesVo.id" />
				<div class="">
						...
						<tr>
							<td>
								...
								<div
									...
									<ul id="zTree"
										turl="${basePath}consumables/labConType/ajaxLabConsumablesZtree.action"
