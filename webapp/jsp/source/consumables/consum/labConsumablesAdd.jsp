...
html {
	_overflow-x: hidden;
		...
		<script>
			...
			function ajaxIsExistName(name,size){//验证编号重复
				...
				$.ajax({
					url:'${basePath}consumables/labConsumables/ajaxIsExistName.action',
					type:'POST',
					data:{'name':name,'size':size},
					dataType:'text',
					success:function(data){
						if(data=='1'){
						    validate.tip("耗材编号已经存在.",$('#functionId'));
							$(obj).val("");
							$(obj).select();
						}
					},
	...
	<body class="" id="mainid">
		<form action="${basePath}consumables/labConsumables/addLabConsumables.action"
			...
			<input type="hidden" id="type"
				name="labConsumablesVo.consumablesTypeId"
								...
								<td>
									<div class="myworkingbox">
										<div class="myworkingboxttitle">
											<h2>
												${funName}：
												<span>[<font color="blue">${labConsumablesVo.consumablesTypeName}</font>]><s:text name="admin.add"/></span>
											</h2>
										</div>
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a uri="consumables/labConsumables/addLabConsumables.action"
																		value="lab.code.save" />
																</td>
															</tr>
														</table>
										...
										<div class="Formtable">
											...
											<table class="FormtableCon">
												<tr>
													...
													<td>
														<input name="labConsumablesVo.code"
															value="${labConsumablesVo.code }" id="code"
															valType="required,strLength" max="32" readonly="true"
															strLength-msg="耗材编码不能超过32位" msg="耗材编码不能为空" type="text"
															size="40" />
													</td>
													<td>
														<label>
													...
													<td>
														<input name="labConsumablesVo.name"
															value="${labConsumablesVo.name }" id="name"
															valType="required,strLength" max="128"
															strLength-msg="耗材名称长度不能超过128位" msg="耗材名称不能为空" type="text"
															size="40" />
													</td>
													</tr>
												<tr>
													...
													<td>
														<input name="labConsumablesVo.size"
															value="${labConsumablesVo.size}" id="size"
															valType="required,strLength" max="32"
															strLength-msg="耗材规格长度不能超过32位" msg="耗材规格不能为空" type="text"
															size="40" />
													</td>
													<td>
														<label>
													...
													<td>
														<s:select list="#request.codeList"
															value="${labConsumablesVo.dangerSize}"
															name="labConsumablesVo.dangerSize" headerKey=""
												...
												<tr>
													...
													<td>
														<input name="labConsumablesVo.amount"
															...
															size="40" type="text" />
														<input name="labConsumablesVo.uuid"
															value="${labConsumablesVo.uuid}" id="uuid" size="40"
															type="hidden" />
													</td>
														</tr>
												<tr>
													...
													<td>
														<s:select list="#request.labOrgVoList" theme="simple"
															name="labConsumablesVo.saveOrg" headerKey=""
															headerValue="" value="${labConsumablesVo.saveOrg}"
													...
													<td>
														<input name="labConsumablesVo.saveUser" onclick="selectLabUser();"
															value="${labConsumablesVo.saveUser }" valType="strLength"
												...
												<tr>
													...
													<td>
														<input name="labConsumablesVo.safeDate"
															value="${labConsumablesVo.safeDate }" valType="strLength"
												...
												<td>
													...
													<td>
														<s:select list="#request.supplierList" theme="simple"
															name="labConsumablesVo.unit" headerKey=""
															headerValue="" value="%{labConsumablesVo.unit}"
												...
												<tr>
													...
													<td colspan="">
														<textarea rows="3" cols="36"
															...
															max="128" strLength-msg='<s:property value="getText('remarknot128')"/>' id="remark"></textarea>
													</td>
													...
													<td colspan="">
														<a id="BtnEdit" class="zPushBtn"
															...
															onclick="uploadFile('${labConsumablesVo.uuid}','lab-consumables');">
