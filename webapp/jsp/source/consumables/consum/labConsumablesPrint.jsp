												...
												<s:if test="labConsumablesVoList!=null">
													...
													<s:iterator value="#alllist" status="st">
														...
														<tr>
															<td>
																<img
																	src="<%=basePath%>jsp/source/consumables/barCode/${id}.png"
																	alt="二维码"
...
function printlnTable() {
	...
	function CcontePrintPage() {
		...
		LODOP.SET_PRINT_PAGESIZE(1,"80mm","55mm","CconteCustomPage"); 
