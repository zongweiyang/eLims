...
html {
	...
	<body class="" id="mainid">
		<form action="${basePath}consumables/labConsumables/addLabStandard.action"
								...
								<td>
									<div class="myworkingbox">
										<div class="myworkingboxttitle">
											<h2>
												${funName}：
												<span>[<font color="blue">${labConsumablesVo.consumablesTypeName}</font>]><s:text name="look.check"/></span>
											</h2>
										</div>
										...
										<div class="Formtable">
											...
											<table class="FormtableCon">
												...
												<td>
													...
													<td>
														<input name="labConsumablesVo.name" id="name"
															valType="required,strLength" max="128"
															strLength-msg="耗材名称长度不能超过128位" msg="耗材名称不能为空" type="text"
															size="40" value="${labConsumablesVo.name}" disabled="true"/>
														<input name="labConsumablesVo.id" id="id" type="hidden"
															size="40" value="${labConsumablesVo.id}" />
														<input name="labConsumablesVo.isDel" id="isDel"
															type="hidden" size="40" value="${labConsumablesVo.isDel}" />
													</td>
														</tr>
												<tr>
													<td>
													...
													<td>
														<input name="labConsumablesVo.size" id="size"
															valType="required,strLength" max="32"
															strLength-msg="耗材规格长度不能超过32位" msg="耗材规格不能为空" type="text"
															size="40" value="${labConsumablesVo.size}" disabled="true"/>
													</td>
													<td>
														<label>
