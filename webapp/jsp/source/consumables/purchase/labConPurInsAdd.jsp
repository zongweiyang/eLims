	...
	_overflow-x: hidden;
		...
		<script>
		   ...
		   function reLoadPage(ids){
		   	var url='consumables/labConPurMain/preAddLabConPurIns.action?labConPurMainVo.consumablesId='+ids;
		   	$('form').attr('action','${basePath}'+url);
			$('form').submit();
		   }
		</script>
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a
																		uri="consumables/labConPurMain/addLabConPurIns.action?labConPurMainVo.auditResult=0"
																		value="lab.code.save" />
																</td>
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="javascript:;"
																		onclick="javascript:if(confirm('确认要提交吗?')){goAction('updateLabConPur4Ins.action?labConPurMainVo.auditResult=1');}return false;"><img
																			height="20" width="20"
																			src="${basePath}img/xinjian.gif" /><b><s:text name="saveinboudn"/></b> </a>
																</td>
															</tr>
														</table>
													</td>
