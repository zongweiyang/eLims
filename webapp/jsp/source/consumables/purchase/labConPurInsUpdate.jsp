	...
	_overflow-x: hidden;
		...
		<script>
		    ...
		    function reLoadPage(ids){
			   	var url='consumables/labConPurMain/preUpdateLabConPurIns.action?labConPurMainVo.consumablesId='+ids;
			   	$('form').attr('action','${basePath}'+url);
				$('form').submit();
		   }
		</script>
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a img="/img/add.gif" 
																		uri="consumables/labConPurMain/updateLabConPurIns.action?labConPurMainVo.auditResult=0"
																		value="lab.code.save" />
																</td>
																<td>
																	<l:a img="/img/add.gif" 
																		uri="consumables/labConPurMain/updateLabConPur4Ins.action?labConPurMainVo.auditResult=1"
																		value="save.inbound" />
																</td>
															</tr>
														</table>
