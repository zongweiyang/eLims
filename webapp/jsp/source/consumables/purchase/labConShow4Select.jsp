...
#roletext {
	...
	text-overflow: ellipsis; /* 支持 IE */
		...
		$(function(){
			$('input[name*="consumablesId"]',D).each(function(){
		...
		function submitvalueforlist(){
			var ids="";
			$('input[name="labConsumablesVo.ids"]').each(function(){
	...
	<body class="" id="mainid">
		<s:form theme="simple" action="" method="post" name="labConForm">
						...
						<table class="workingBody" cellspacing="0" cellpadding="0"
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<s:select name="labConsumablesVo.consumablesTypeId"
																		list="#request.labConTypeVoList" listValue="name"
																...
																<td>
																	<input type="text" name="labConsumablesVo.name"
																		id="name" value="${labConsumablesVo.name}" />
																</td>
																<td>
										...
										<table class="myworkingboxttable" cellspacing="0"
											...
											<thead>
												<tr>
													...
													<th property="consumablesType.id">
														<s:text name="contype"/>
													</th>
													<th property="size">
							...
							<tr>
								<td align="center"><jsp:include
										page="/jsp/include/page.jsp?formName=labConForm" flush="true" /></td>
							</tr>
						</table>
					</td>
					<td class="MRimg"></td>
