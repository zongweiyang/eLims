...
#roletext {
	...
	function submitValue(pid)	{
		var df = document.labDocForm;
			df.action="<%=basePath%>doc/labDoc/addLabDocFile.action";
	 		df.submit();
	}
				...
				<td id="bodyCell" class="oRight">
					<div class="myworkingbox">
						<div class="myworkingboxttitle">
							<h2>
								${funName }：
								<span>${path}&nbsp;&nbsp;[<font color="red"><s:text name="admin.add"/></font>]</span>
							</h2>
						</div>
						<form action="addLabUser" method="post" name="labDocForm" id="form">
							<input type="hidden" name="labDocVo.pid" value="${labDocVo.pid}" />
							<input type="hidden" name="path" value="${path}" />
							<input type="hidden" name="labDocVo.uuid" value="${labDocVo.uuid}" />
											...
											<td class="blockTd" style="padding: 6px 10px; vertical-align: center;">
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														...
														<td>
															<l:a uri="doc/labDoc/addLabDocFile.action" onclick="submitValue('${labDocVo.pid}');return false;" value="lab.code.save" />
														</td>
													</tr>
												</table>
											</td>
									...
									<div style="margin: 10px 50px 10px 50px;">
										<table class="FormtableCon">
											<tr>
												...
												<td>
													<input name="labDocVo.fileName" valType="required,strLength" max="64" msg="文件名不能为空" strLength-msg="文件名长度不能超过64位" type="text" size="20" value="${labDocVo.fileName}" />
												</td>
											</tr>
											<tr>
												<td class="c">
												...
												<td>
													<input  id="keyWord" name="labDocVo.keyWord" value="${labDocVo.keyWord}" type="text"/>
												</td>
											</tr>
											<tr>
												<td class="c">
											...
											<tr>
												...
												<td colspan="3">
													<textarea name="labDocVo.summary" id="summary" rows="10" cols="88">${labDocVo.summary }</textarea>
												</td>
											</tr>
											<tr>
												<td class="c">
											...
											<tr>
												...
												<td style="border: 0">
													<textarea cols="50" rows="4" name="labDocVo.remark" valType="strLength" max="512" strLength-msg='<s:property value="getText('remakrnot512')"/>'>${labDocVo.remark }</textarea>
												</td>
											</tr>
										</table>
									</div>
