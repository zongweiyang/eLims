		...
		function submitValue()	{
			if($('#fileName').val()==''){
				...
				var df = document.labDocForm;	
		 		df.action="<%=basePath%>doc/labDoc/updateLabDocFolder.action";
		  		df.submit();
			}
		}
		</script>
									...
									<div class="">
															...
															<tr>
																...
																<a id="BtnPreview" class="zPushBtn" href="javascript:;"
																	onclick="submitValue();return false;"><img
																		height="20" width="20"
																		src="<%=basePath%>img/add.gif" /><b><s:text name="lab.code.save"/></b> </a>
																</td>
															</tr>
														</table>
													</td>
										...
										<table class="myworkingboxttable" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td colspan="2">
													<input name="labDocVo.fileName"  type="text" id="fileName" value="${labDocVo.fileName}"/>
											...
											<tr>
												...
												<td colspan="2">
													<textarea rows="4" cols="55" name="labDocVo.remark" valType="strLength"  max="512"  strLength-msg='<s:property value="getText('remakrnot512')"/>'>${labDocVo.remark}</textarea>
												</td>
											</tr>
											<tr>
												...
												<td class="l" colspan="3">
													<input type="radio" value="folder_doc.png"
														name="labDocVo.docIcon" <s:if test="${labDocVo.docIcon=='folder_doc.png'}">checked="checked"</s:if>/>
													
													<img src="<%=basePath%>img/folder_doc.png" height="70" />
													&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" value="folder_file.png"
														name="labDocVo.docIcon" <s:if test="${labDocVo.docIcon=='folder_file.png'}">checked="checked"</s:if> />
													<img src="<%=basePath%>img/folder_file.png" height="70" />
													&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" value="folder_doc1.png"
														name="labDocVo.docIcon" <s:if test="${labDocVo.docIcon=='folder_doc1.png'}">checked="checked"</s:if>/>
