			...
			function submitvalue(){
				var appIds="";
	       		...
	       		$('input[name*=labApparaVo.ids]:checked').each(function (linked){
	       			var check=$(this);
	       			var appId=$(check).val();
	       			var appNo=$(check).attr('appNo');
	       			var appCode=$(check).attr('appCode');
	       			appIds+=appId+",";
	       			appNos+=appNo+",";
	       			appCodes+=appCode+",";
	       		});
				...
				if(appNos.length>0){
					appNos=appNos.substring(0,appNos.length-1);
				}
								...
								<td>
									<div class="myworkingbox_pop">
											...
											<s:if test="pageResult!=null">
												<s:if test="pageResult.resultList!=null">
													...
													<s:iterator value="#alllist" status="st">
														<tr>
															<td class="c">
																<input key="${id}" style="border: 1px;" index="${st.index+1}"  appNo="${no}" appCode="${spec }" type="checkbox" name="labApparaVo.ids" value="${id}" id="ids${st.index+1}"/>
															</td>
															<td class="c">
										...
										<div style="padding-top: 20px;">
											<jsp:include
										page="/jsp/include/page.jsp?formName=form"
										flush="true" />
										</div>
									</div>
								</td>
