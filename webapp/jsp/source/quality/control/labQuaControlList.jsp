					                      			...
					                      			<td class="blockTd" style="padding: 6px 10px;vertical-align:center;">
					                      				<table cellspacing="0" cellpadding="0" border="0">
					                      					<tr>
																...
																<td>
																	<s:select list="unitOrgVoList" headerKey="" headerValue="--全部--" onchange="selectChange(this);"
														...
														<tr>
															...
															<td class="c">
																...
																<s:if test="${accStatus == ''|| accStatus == null || accStatus=='0'}">
																	&nbsp;&nbsp;
																	<l:a href="#" uri="quality/accident/preAddLabQuaAccident4Other.action"  onclick="selectAccident('${id}','ACC-JDCC');" value="转事故"/>	
																</s:if>
															</td>
														</tr>
													</s:iterator>
