...
<html>
	...
	<body class="" id="mainid">
		...
		<input name="labQuaControlVo.id" type="hidden" value="${labQuaControlVo.id }" />
		<input name="labQuaControlVo.anaNo" type="hidden" value="${labQuaControlVo.anaNo }" />
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a uri="quality/control/updateLabQuaControl.action" onclick="goAction('updateLabQuaControl.action');" value="lab.code.save"/>
																</td>
															</tr>
														</table>
													</td>
										...
										<div class="Formtable">
											...
											<table class="FormtableCon">
												...
												<td>
													...
													name="labQuaControlVo.unitOrgSearch" value="'${labQuaControlVo.unitOrgId}|${labQuaControlVo.unitOrgName }'" id="unitOrgId" theme="simple"
												...
												<td>
													...
													name="labQuaControlVo.labOrgSearch" value="'${labQuaControlVo.labOrgId}|${labQuaControlVo.labOrgName }'" id="labOrgId" theme="simple"
											...
											<tr>
												...
												<td>
														<input size="40" name="labQuaControlVo.appNo" id="appNo" type="text"
															  value="${labQuaControlVo.appNo }"  valType="required" msg="仪器编号不能为空" />
												</td>
											</tr>
											<tr>
												<td class="r" width="150">
												...
												<td>
														<input size="40" name="labQuaControlVo.anaPeople" id="anaPeople" type="text"
															    value="${labQuaControlVo.anaPeople }" />
												</td>
												<td class="r" width="150">
												...
												<td>
													<input size="40" name="labQuaControlVo.testTime" id="testTime" readonly="readonly" 
														type="text"  value="${labQuaControlVo.testTime }" class="Wdate"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" />
												</td>
											</tr>
											<tr>
											    <td class="r" width="150">
												...
												<td>
														<input size="40" name="labQuaControlVo.conPeople" id="conPeople" type="text"
															    value="${labQuaControlVo.conPeople }" />
												</td>
												<td class="r" width="150">
												...
												<td>
													<input size="40" name="labQuaControlVo.conTime" id="conTime" readonly="readonly" 
														type="text"  value="${labQuaControlVo.conTime }" class="Wdate"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" />
												</td>
											</tr>
											</table>
										</div>
														...
														<s:iterator value="#alllist" status="st">
															<tr>
																<td class="c" width="150">
																	${comCodeName }
																	<input type="hidden" name="labQuaControlVo.labQuaControlDetailVoList[${st.index}].comCodeId" value="${comCodeId }" />
																	<input type="hidden" name="labQuaControlVo.labQuaControlDetailVoList[${st.index}].id" value="${id}" />
																	<input type="hidden" name="labQuaControlVo.labQuaControlDetailVoList[${st.index}].comCodeName" value="${comCodeName }" />
																</td>
																<td  class="c">
																	<input name="labQuaControlVo.labQuaControlDetailVoList[${st.index}].statusDesc"  type="text" size="40"  value="${statusDesc }" />
																</td>
																<td  class="c">
																	<input name="labQuaControlVo.labQuaControlDetailVoList[${st.index}].proResult"  type="text" size="40"  value="${proResult }" />
																</td>
															</tr>
														</s:iterator>
													</s:if>
									...
									<div class="Formtable">
										...
										<table class="FormtableCon" id="twoTable">
											<tr>
												...
												<td colspan="3">
														<textarea name="labQuaControlVo.evaluation" cols="40" rows="3" id="evaluation">${labQuaControlVo.evaluation }</textarea>
												</td>
											</tr>
										</table>
									</div>
