								...
								<td>
									<div class="myworkingbox">
										<div class="myworkingboxttitle">
											<h2>
												${funName }：
												<span>检查内容&nbsp;&nbsp;[<font color="red"><s:text name="lab.code.modify"/></font>]</span>
											</h2>
										</div>
										...
										<div class="Formtable">
											...
											<table class="FormtableCon">
										 		<tr>
										 			<td class="r" width="120"><label>检查内容：</label></td>
										 			<td>
										 				<textarea cols="50" rows="4" valType="required" msg="检查内容不能为空" name="labQuaInitAuditPlanVo.name" id="name">${labQuaInitAuditPlanVo.name}</textarea>
										 			</td>
										 		</tr>
											</table>
										</div>
