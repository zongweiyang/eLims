...
html {
	...
	<body class="" id="mainid">
		<s:form theme="simple" action="" method="post" name="labReaCheckform">
						...
						<table class="workingBody" cellspacing="0" cellpadding="0"
															...
															<tr>
																...
																<td>
																	<input type="text" name="labReaCheckMainVo.checkno"
																		value="${labReaCheckMainVo.checkno}" id="checkno"
																		size="20" />
																</td>
																<td>
																	<label>
																...
																<td>
																	<input type="text" name="labReaCheckMainVo.name"
																		value="${labReaCheckMainVo.name }" id="name" size="20" />
																</td>
																<td>
																	<label>
																		<s:text name="pandian"/>：
																...
																<td>
																	<input type="text" name="labReaCheckMainVo.checker"
																		id="checker" value="${labReaCheckMainVo.checker}" />
																</td>
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a uri="reagent/labReaCheckMain/preAddLabReaCheckMain.action"
																		value="admin.add" />
																</td>
															</tr>
														</table>
												...
												<s:if test="pageResult.resultList!=null">
													...
													<s:iterator value="#alllist" status="st">
														<tr>
															...
															<td class="c">
																<l:a href="#"
																	uri="reagent/labReaCheckMain/showLabReaCheckMain.action?labReaCheckMainVo.id=${id}"
																	value="look.check" />
															</td>
														</tr>
													</s:iterator>
							...
							<tr>
								<td align="center"><jsp:include
										page="/jsp/include/page.jsp?formName=labReaCheckform"
										flush="true" /></td>
							</tr>
						</table>
					</td>
