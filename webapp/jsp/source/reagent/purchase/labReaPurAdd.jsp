	...
	_overflow-x: hidden;
		...
		<script>
		   ...
		   function reLoadPage(ids){
		   	...
		   	var url='reagent/labReaPurMain/preAddLabReaPur.action?labReaPurMainVo.reagentId='+ids;
		   	$('form').attr('action','${basePath}'+url);
			$('form').submit();
		   }
		</script>
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a uri="reagent/labReaPurMain/addLabReaPur.action?labReaPurMainVo.auditResult=0"
																		onclick="goToNextAction('reagent/labReaPurMain/addLabReaPur.action?labReaPurMainVo.auditResult=0');return false;" value="lab.code.save" />

																</td>
																<td>
																	<l:a uri="reagent/labReaPurMain/addLabReaPur.action?labReaPurMainVo.auditResult=1"
																		onclick="goToNextAction('reagent/labReaPurMain/addLabReaPur.action?labReaPurMainVo.auditResult=1');return false;" value="save.commit" />
																</td>
															</tr>
														</table>
													</td>
												...
												<table class="FormtableCon">
													...
													<tr>
														...
														<td rowspan="3" colspan="3">
															<textarea id="remark" name="labReaPurMainVo.remark"
