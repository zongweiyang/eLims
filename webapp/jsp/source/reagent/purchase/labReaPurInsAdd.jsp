	...
	_overflow-x: hidden;
		...
		<script>
		   ...
		   function reLoadPage(ids){
		   	var url='reagent/labReaPurMain/preAddLabReaPurIns.action?labReaPurMainVo.reagentId='+ids;
		   	$('form').attr('action','${basePath}'+url);
			$('form').submit();
		   }
		</script>
															...
															<tr>
																...
																<td>
																	<l:a uri="reagent/labReaPurMain/addLabReaPur.action?labReaPurMainVo.auditResult=0"
																		onclick="goToNextAction('reagent/labReaPurMain/addLabReaPurIns.action?labReaPurMainVo.auditResult=0');return false;" value="lab.code.save" />

																</td>
																<td>
																	<l:a uri="reagent/labReaPurMain/addLabReaPur.action?labReaPurMainVo.auditResult=1"
																		onclick="javascript:if(confirm('确认要提交吗?')){goToNextAction('updateLabReaPur4Ins.action?labReaPurMainVo.auditResult=1');}return false;" value="save.commit" />
																</td>
															</tr>
														</table>
													</td>
