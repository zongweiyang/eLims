	...
	_overflow-x: hidden;
		...
		<script>
		    ...
		    function reLoadPage(ids){
			   	var url='reagent/labReaPurMain/preUpdateLabReaPur.action?labReaPurMainVo.reagentId='+ids;
			   	$('form').attr('action','${basePath}'+url);
				$('form').submit();
		   }
		</script>
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a
																		uri="reagent/labReaPurMain/updateLabReaPurMain.action?labReaPurMainVo.auditResult=0"
																		onclick="goToNextAction('reagent/labReaPurMain/updateLabReaPurMain.action?labReaPurMainVo.auditResult=0');return false;" value="lab.code.save" />
																</td>
																<td>
																	<l:a
																		uri="reagent/labReaPurMain/updateLabReaPurMain.action?labReaPurMainVo.auditResult=1"
																		onclick="goToNextAction('reagent/labReaPurMain/updateLabReaPurMain.action?labReaPurMainVo.auditResult=1');return false;" value="save.commit" />
																</td>
															</tr>
														</table>
													</td>
												...
												<table class="FormtableCon">
													<tr>
														...
														<td>
															<input type="text" name="labReaPurMainVo.receiptno"
																...
																strLength-msg='<s:property value="getText('appname32')"/>' msg='<s:property value="getText('appnamenotempty')"/>'
																value="${labReaPurMainVo.receiptno}" valType="" />
														...
														<td>
															<input name="labReaPurMainVo.createTime"
																...
																strLength-msg='<s:property value="getText('apptimenot64')"/>' msg='<s:property value="getText('apptimenotrm')"/>'
													...
													<tr>
														...
														<td rowspan="3" colspan="3">
															<textarea name="labReaPurMainVo.remark"
																valType="strLength" max="512"
																strLength-msg='<s:property value="getText('remakrnot512')"/>'
																value="${labReaPurMainVo.remark}" size="20" rows="2"
																cols="60">${labReaPurMainVo.remark } </textarea>
														</td>
													</tr>
												</table>
											</div>
														...
														<tr>
															...
															<td class="c">
																<input type="text" valType="strLength" max="512"
																	strLength-msg='<s:property value="getText('remmakrnot32')"/>'
