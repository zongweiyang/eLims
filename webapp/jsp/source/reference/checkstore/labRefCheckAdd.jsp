													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a uri="reference/labRefCheckMain/addLabRefCheckMain.action"
																		value="lab.code.save" />
																</td>
															</tr>
														</table>
											...
											<div class="Formtable">
												...
												<table class="FormtableCon">
													<tr>
														...
														<td>
															<input type="text" name="labRefCheckMainVo.checkno"
																...
																value="${labRefCheckMainVo.checkno}" />
														</td>
														<td>
															<label>
																<s:text name="pandian"/>：
														...
														<td>
															<input type="text" name="labRefCheckMainVo.checker"
																...
																value="${labRefCheckMainVo.checker}" />
														</td>
														<td>
															<label>
														...
														<td>
															<input type="text" name="labRefCheckMainVo.checktime"
																value="${labRefCheckMainVo.checktime}" class="Wdate"
																size="20"
														...
														<td>
															<input type="text" name="labRefCheckMainVo.name"
													...
													<s:iterator
														...
														<tr>
															...
															<td class="l">
																${thisAmount }
																<input type="hidden"
																	name="labRefCheckMainVo.labRefCheckDetailVoList[${st.index}].thisAmount"
																	value="${thisAmount}" />
															</td>
															<td class="c">
																<input type="text" valType="required,strLength" max="16"
																	...
																	name="labRefCheckMainVo.labRefCheckDetailVoList[${st.index}].amount"
																	value="${amount}" />
															</td>
															<td class="c">
																<input type="text"
																	name="labRefCheckMainVo.labRefCheckDetailVoList[${st.index}].remark"
