	...
	_overflow-x: hidden;
		...
		<script>
			...
			function ajax2LabRefList(){
				var url  = '${basePath}reference/labRefPurMain/ajax4ListLabPur.action';
				$.dialog({
					id:'roleId',
					content:'url:'+url,
		    ...
		    function reLoadPage(ids){
			   	var url='reference/labRefPurMain/showLabRefPur4Ins.action?labRefPurMainVo.referenceId='+ids;
			   	$('form').attr('action','${basePath}'+url);
				$('form').submit();
		   }
		</script>
															...
															<tr>
																...
																<td>
																	<a id="BtnPreview" class="zPushBtn" href="javascript:;"
																		onclick="javascript:if(confirm('确认要提交吗?')){goAction('updateLabRefPur4Ins.action?labRefPurMainVo.auditResult=1');}return false;"><img
																			height="20" width="20"
