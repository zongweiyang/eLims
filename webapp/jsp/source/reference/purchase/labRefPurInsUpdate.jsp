	...
	_overflow-x: hidden;
		...
		<script>
		    ...
		    function reLoadPage(ids){
			   	var url='reference/labRefPurMain/preUpdateLabRefPurIns.action?labRefPurMainVo.referenceId='+ids;
			   	$('form').attr('action','${basePath}'+url);
				$('form').submit();
		   }
		</script>
													...
													<td class="blockTd"
														...
														<table cellspacing="0" cellpadding="0" border="0">
															<tr>
																...
																<td>
																	<l:a
																		uri="reference/labRefPurMain/updateLabRefPurIns.action?labRefPurMainVo.auditResult=0"
																		onclick="goToNextAction('reference/labRefPurMain/updateLabRefPurIns.action?labRefPurMainVo.auditResult=0');return false;"
																		value="lab.code.save" />
																</td>
																<td>
																	<l:a
																		uri="reference/labRefPurMain/updateLabRefPur4Ins.action?labRefPurMainVo.auditResult=1"
																		onclick="goToNextAction('reference/labRefPurMain/updateLabRefPur4Ins.action?labRefPurMainVo.auditResult=1');return false;"
