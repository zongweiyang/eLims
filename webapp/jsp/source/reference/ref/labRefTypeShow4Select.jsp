...
html {
	...
	var api = frameElement.api, W = api.opener, D = W.document; // api.opener 为载加lhgdialog.min.js文件的页面的window对象
		...
		function submitvalueforlist(){
			...
			df.action=basePath+"reference/labReference/updateLabReferenceMove.action?labReferenceVo.referenceTypeId="+funIds;
		    df.submit();
		    closeMe();
		}
	...
	<body class="" id="mainid" style="overflow-y: auto;">
		<div id="popup">
			<form name="listForm" action="#" method="post" target="workarea">
				<input type="hidden" value="${labReferenceVo.id}"
					id="labReferenceId" name="labReferenceVo.id" />
				<div class="">
						...
						<tr>
							<td>
								...
								<div
									...
									<ul id="zTree"
										turl="${basePath}reference/labRefType/ajaxLabReferenceZtree.action"
