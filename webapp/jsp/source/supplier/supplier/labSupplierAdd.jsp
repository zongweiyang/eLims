...
<html>
	<head>
		...
		<script type="text/javascript" src="${basePath}js/multiSelect/jquery.bgiframe.min.js"></script>
		<script type="text/javascript" src="${basePath}js/multiSelect/jquery.multiselect.js"></script>
		<link rel=stylesheet href="${basePath}multiSelect/jquery.multiSelect.css" type="text/css">
											...
											<td class="blockTd"
												...
												<table cellspacing="0" cellpadding="0" border="0">
													<tr>
														...
														<td>
															<l:a uri="supplier/labSupplier/addLabSupplier.action"
																value="lab.code.save" />
														</td>
													</tr>
												</table>
										...
										<tr>
											...
											<td>
												<s:select list="#request.typeList"
													name="labSupplierVo.goodsType" multiple="multiple" headerKey=""
													headerValue="" theme="simple" listKey="name"
													listValue="name"></s:select>
											</td>
											<td>
