...
<script language="javascript">
	...
	function browserVersion(){
		if($.browser.msie){
			...
			if($.browser.version!='8.0'){
				alert('请使用FireFox7版本浏览器');
			}
		}
		else{
			alert('请使用IE8.0或FireFox7版本以上浏览器');
		}
	}
</script>
<script language="javascript">
...
<div class="loginBox">
<p class="udunjiance" id="msgTxt" style="color:#f60;">登陆中...</p>
...
<div>推荐浏览器：<a href="http://windows.microsoft.com/zh-CN/internet-explorer/products/ie-8/ie8-how-to" class="browerHref">IE8</a>、<a href="http://firefox.com.cn/" class="browerHref">FireFox7</a>及以上&nbsp;&nbsp;&nbsp;&nbsp;建议分辨率1024X768以上</div>
