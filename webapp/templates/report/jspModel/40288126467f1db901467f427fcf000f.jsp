<div><P style="TEXT-ALIGN: center" class="content-head">&nbsp;</P>
...
<P>&nbsp;</P>
<P>&nbsp;</P>
<P>&nbsp;</P></TD></TR></TBODY></TABLE></div><div><P>&nbsp;</P>
<TABLE style="DISPLAY: none" class="areport-each-table1" code="labSamReportVo.reportDataList">
<THEAD>
<TR>
<TH style="BORDER-BOTTOM: #000 1px solid; BORDER-LEFT: #000 1px solid; BORDER-TOP: #000 1px solid; BORDER-RIGHT: #000 1px solid">样品编号</TH>
<TH style="BORDER-BOTTOM: #000 1px solid; BORDER-LEFT: #000 1px solid; BORDER-TOP: #000 1px solid; BORDER-RIGHT: #000 1px solid">样品名称</TH>
<TH style="BORDER-BOTTOM: #000 1px solid; BORDER-LEFT: #000 1px solid; BORDER-TOP: #000 1px solid; BORDER-RIGHT: #000 1px solid">检测项目</TH>
<TH style="BORDER-BOTTOM: #000 1px solid; BORDER-LEFT: #000 1px solid; BORDER-TOP: #000 1px solid; BORDER-RIGHT: #000 1px solid">检测方法</TH>
<TH style="BORDER-BOTTOM: #000 1px solid; BORDER-LEFT: #000 1px solid; BORDER-TOP: #000 1px solid; BORDER-RIGHT: #000 1px solid">检测结果</TH></TR></THEAD>
<TBODY><s:iterator status="st" value="labSamReportVo.reportDataList">
<TR>
<TD code="sampCode">${sampCode}</TD>
<TD code="labSamName">${labSamName}</TD>
<TD code="itemName">${itemName}</TD>
<TD code="methodName">${methodName}</TD>
<TD code="testResult">${testResult}</TD></TR>
</s:iterator></TBODY></TABLE>
<TABLE class="areport-each-table cke_show_border" code="labSamReportVo.reportDataList">
<THEAD>
<TR>
<TH style="BORDER-BOTTOM: #000 1px solid; BORDER-LEFT: #000 1px solid; BORDER-TOP: #000 1px solid; BORDER-RIGHT: #000 1px solid">样品编号</TH>
<TH style="BORDER-BOTTOM: #000 1px solid; BORDER-LEFT: #000 1px solid; BORDER-TOP: #000 1px solid; BORDER-RIGHT: #000 1px solid">样品名称</TH>
...
<TBODY>
<TR>
<TD code="sampCode"><SPAN class="are-page-data1 are-page-data-css">样品编号</SPAN></TD>
<TD code="labSamName"><SPAN class="are-page-data1 are-page-data-css">样品名称</SPAN></TD>
<TD code="itemName"><SPAN class="are-page-data1 are-page-data-css">检测项目</SPAN></TD>
<TD code="methodName"><SPAN class="are-page-data1 are-page-data-css">检测方法</SPAN></TD>
<TD code="testResult"><SPAN class="are-page-data1 are-page-data-css">检测结果</SPAN></TD></TR></TBODY></TABLE></div>