...
<DIV style="MIN-WIDTH: 50px; TEXT-ALIGN: left; FLOAT: left; FONT-SIZE: 15px"><SPAN style="WIDTH: 103.32%; HEIGHT: 15px; FONT-SIZE: 12px" class="are-page-data" key="${labSamReportVo.finishDate}" key1="labSamReportVo.finishDate">2014-08-06</SPAN></DIV></DIV>
<P>&nbsp;</P>
...
<P style="LINE-HEIGHT: 40px" class="table-p">&nbsp;</P>
<P style="LINE-HEIGHT: 40px" class="table-p"><SPAN style="FONT-SIZE: 12px" class="are-page-data" key="${labSamReportVo.testResult}" key1="labSamReportVo.testResult">xx</SPAN></P>
<P style="LINE-HEIGHT: 40px" class="table-p">&nbsp;</P>
...
<P>&nbsp;</P>
<P>&nbsp;</P>
<P><SPAN style="FONT-SIZE: 12px" class="are-page-data" key="${labSamReportVo.remark}" key1="labSamReportVo.remark">xxx</SPAN></P>
<P>&nbsp;</P>
<P>&nbsp;</P>
<P>&nbsp;</P>
<P>&nbsp;</P>
