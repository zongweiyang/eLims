...
<body style="background:url(<%=basePath%>img/sidebar_bg.png) repeat-y right top;">
    ...
    <div class="sidebar">
      <div class="userinfo">
          ...
          <div class="userinfobox">
            <p class="userdate"><s:text name="theme.date"/>：${labUserVo.currentDate}</p>
            <p class="userunit"><s:text name="theme.depart"></s:text>：${labUserVo.orgName}</p>
