...
<tr>
  <td colspan="2" align="center"><p id="msgTxt" style="color:#F00;"><s:text name="theme.logining"/></p></td>
</tr>
...
<script type="text/javascript" language="JavaScript">
	...
	window.setTimeout(function(){document.all.msgTxt.innerHTML='<s:property value="getText('theme.logining')"/>';},2000);
		try{
			...
			window.setTimeout(function(){document.all.msgTxt.innerHTML='<s:property value="getText('theme.net.fail')"/>;};},2000);
		}
	}
