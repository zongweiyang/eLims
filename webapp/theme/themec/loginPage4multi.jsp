...
<input type="text" id="loginname" name="labUserVo.loginname" class="usernameinput" style="height:20px;line-height:20px;width:200px;font-sie:14px;padding-left:2px;" /> 
<!--<s:text name="login.password"/>-->
<input type="password" id="password" name="labUserVo.password" value="" class="userpasswordinput" style="height:20px;line-height:20px;width:200px;font-sie:14px;padding-left:2px;" /> 
