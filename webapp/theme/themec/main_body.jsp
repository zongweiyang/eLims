...
<script>
	function setFullWindow(){
		window.frames['topFrame'].hideAndShow();
	}
</script>
<frameset id="top" rows="104,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset id="bottomid" cols="190,*" frameborder="no" border="0" framespacing="0">
    ...
    <frame src="<%=basePath %>jsp/include/progress_bar.jsp?url=/portlets/showPortlets.action" name="workarea" scrolling="auto" id="MianFrame"/>
  </frameset>
</frameset>
