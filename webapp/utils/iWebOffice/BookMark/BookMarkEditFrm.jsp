...
function ConfirmDel(FileUrl){
	...
	<body bgcolor="#ffffff">
		<div align="center">
			<font size=4 color="ff0000">标签管理〖修改标签〗</font>
		</div>
		<hr size=1>
		<br>
		<%
			...
			<table border=0 cellspacing='0' cellpadding='0' width=100% align=center class=TBStyle>
				<tr>
					...
					<td class="TDStyle" width="90%">
						<input type="text" name="BookMarkName" size="50" maxlength="32" class="IptStyle" value="<%=result.getString("BookMarkName")%>">
					</td>
				</tr>
				<tr>
					<td nowrap align=center class="TDTitleStyle" width=64>
					...
					<td class="TDStyle">
						<input type="text" name="BookMarkDesc" size="50" maxlength="60" class="IptStyle" value="<%=result.getString("BookMarkDesc")%>">
					</td>
				</tr>
				<tr>
					<td nowrap align=center class="TDTitleStyle" width=64>
					...
					<td class="TDStyle">
						<input type="text" name="BookMarkText" size="50" maxlength="150" class="IptStyle" value="<%=result.getString("BookMarkText")%>">
					</td>
				</tr>
				<tr>
