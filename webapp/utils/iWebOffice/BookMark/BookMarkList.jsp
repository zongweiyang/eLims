...
function ConfirmDel(FileUrl){
	...
	<body bgcolor="#ffffff">
		<div align="center">
			<font size=4 color=ff0000>标签管理</font>
		</div>
		<hr size=1>
		<br>
		<table border=0 cellspacing='0' cellpadding='0' width=100% align=center class=TBStyle>
			...
			%>
			<tr>
				<td class="TDStyle"><%=mBookMarkID%>&nbsp;
				</td>
				<td class="TDStyle"><%=result.getString("BookMarkName")%>&nbsp;
				</td>
				<td class="TDStyle"><%=result.getString("BookMarkDesc")%>&nbsp;
				</td>
				<td class="TDStyle"><%=result.getString("BookMarkText")%>&nbsp;
				</td>
