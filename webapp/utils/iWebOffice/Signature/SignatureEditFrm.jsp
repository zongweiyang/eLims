...
function ConfirmDel(FileUrl){
	...
	<body bgcolor="#ffffff">
		<div align="center">
			<font size=4 color="ff0000">签章管理〖修改签章〗</font>
		</div>
		<hr size=1>
		<br>
		<%
		...
		<form name="webform" method="post" enctype="multipart/form-data" action="SignatureEdit.jsp" onsubmit="return Check(this)">
			...
			<table border=0 cellspacing='0' cellpadding='0' width=100% align=center class=TBStyle>
				<tr>
					<td nowrap align=center class="TDTitleStyle" width=64>
						用户名称
					</td>
					<td class="TDStyle" width="90%">
						<input type="text" name="UserName" size="50" maxlength="32" class="IptStyle" value="<%=result.getString("UserName")%>">
					</td>
				</tr>
				<tr>
					<td nowrap align=center class="TDTitleStyle" width=64>
					...
					<td class="TDStyle" width="90%">
						<input type="text" name="PassWord" size="50" maxlength="32" class="IptStyle" value="<%=result.getString("PassWord")%>">
					</td>
				</tr>
				<tr>
					<td nowrap align=center class="TDTitleStyle" width=64>
					...
					<td class="TDStyle" width="90%">
						<input type="text" name="MarkName" size="50" maxlength="32" class="IptStyle" value="<%=result.getString("MarkName")%>">
					</td>
				</tr>
				<tr>
					<td nowrap align=center class="TDTitleStyle" width=64>
					...
					<td class="TDStyle">
						<input type="file" name="MarkFile" size="50" maxlength="60" class="IptStyle">
					</td>
				</tr>
				<tr>
