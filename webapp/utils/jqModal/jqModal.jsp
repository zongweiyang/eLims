...
//				alert("work");
	...
	function showID(index){
		var url='<%=basePath%>getApparatusInfoListForSaveMethod.action';
...
<iframe name="frame_div" id="my_iframe" width="620px;" scrolling="no" frameborder="no" height="310px;" border="0″ style="padding:0;margin:0;" name="xxx">
						
</iframe>
<input type="text" name="" id="indexInput" />
</div>
<!-- JQ 模态层 end -->
