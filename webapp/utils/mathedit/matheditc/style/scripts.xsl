...
<xsl:template match="mml:mmultiscripts" mode="mprescripts">
	<xsl:for-each select="mml:mprescripts/following-sibling::*">
	...
	<xsl:apply-templates select="./*[1]"/>
	<xsl:for-each select="mml:mprescripts/preceding-sibling::*[position()!=last()]">
